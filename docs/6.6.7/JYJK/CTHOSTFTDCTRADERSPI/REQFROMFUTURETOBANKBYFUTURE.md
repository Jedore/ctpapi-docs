...
<span class="anchor" id="3033bafb-9600-4756-a34d-e1449588cc71"></span>
## 1.函数原型
<p>virtual int ReqFromFutureToBankByFuture(CThostFtdcReqTransferField *pReqTransfer, int nRequestID) = 0;</p>
<span class="anchor" id="ea380865-d9ba-4b8b-b7bb-43f22041c43c"></span>
## 2.参数
...
<span class="anchor" id="3cfbba67-9cb6-4cac-8799-8d1d756465a0"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="b9a6f0b1-36d7-4f2c-801e-120a06e3237e"></span>
## 4.调用示例
...
<span class="anchor" id="1c33fc31-7ee0-4b2c-aadb-76b15abdc6a6"></span>
## 5.FAQ
<p>无</p>
