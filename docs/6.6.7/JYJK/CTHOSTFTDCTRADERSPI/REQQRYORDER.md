...
<span class="anchor" id="6f7fe19a-0308-41c9-a205-2e40423c616a"></span>
## 1.函数原型
<p>virtual int ReqQryOrder(CThostFtdcQryOrderField *pQryOrder, int nRequestID) = 0;</p>
<span class="anchor" id="d82a8719-96cc-4b1e-a3de-f7523108b81b"></span>
## 2.参数
<p>pQryOrder：查询报单</p>
...
<span class="anchor" id="b4b802b9-33f1-4d17-975d-108ee14abd0c"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="7b0d551d-9773-471b-bf3c-80b25feada54"></span>
## 4.调用示例
...
<span class="anchor" id="a8b906ea-5356-4394-9ad4-1a741987ca00"></span>
## 5.FAQ
<p>无</p>
