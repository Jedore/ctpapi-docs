...
<span class="anchor" id="aeef4932-8c77-4e68-8574-26d8ae465800"></span>
## 1.函数原型
<p>virtual int RegisterUserSystemInfo(CThostFtdcUserSystemInfoField *pUserSystemInfo) = 0;</p>
<span class="anchor" id="9c86f83e-6577-45e0-81a0-42d6c43e137d"></span>
## 2.参数
...
<span class="anchor" id="c3ad922d-4e70-4a4f-8487-2dbed98d4507"></span>
## 3.返回
<p>0 正确</p>
<p>-1 字段长度不对</p>
<p>-2 非CTP采集的终端信息</p>
...
<p>-6 采集结果字段错误</p>
<span class="anchor" id="f63846c5-078b-4ea5-ae79-9f5d92afadc1"></span>
## 4.调用示例
<p>//多对多中继终端使用流程</p>
...
<span class="anchor" id="f537f455-d0ff-4a31-8103-b39e4fd83e7a"></span>
## 5.FAQ
