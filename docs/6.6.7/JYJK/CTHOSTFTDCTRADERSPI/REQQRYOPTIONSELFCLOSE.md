...
<span class="anchor" id="fe0a8157-7734-45bb-a3d0-c8450daef4c2"></span>
## 1.函数原型
<p>virtual int ReqQryOptionSelfClose(CThostFtdcQryOptionSelfCloseField *pQryOptionSelfClose, int nRequestID) = 0;</p>
<span class="anchor" id="e774f25f-6f80-4440-a7ea-c8e37eb8059e"></span>
## 2.参数
...
<span class="anchor" id="67fe8c3e-cfe9-4e71-ad76-ed74be10bba2"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="fd5e2f0e-6d32-4a50-82d2-42587e5494a4"></span>
## 4.调用示例
...
<span class="anchor" id="726f80fa-45dc-45e0-b99a-c753c18d8475"></span>
## 5.FAQ
<p>无</p>
