...
<span class="anchor" id="e72cc766-9d75-4305-982e-9097d758c7eb"></span>
## 1.函数原型
<p>virtual int ReqOptionSelfCloseInsert(CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose, int nRequestID) = 0;</p>
<span class="anchor" id="766f37e9-7fe9-49b0-8467-883a49af350d"></span>
## 2.参数
...
<span class="anchor" id="708d94b2-258e-4f5e-80ca-4a7daae408b7"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="c076b355-9bfe-4ea7-8ba5-69aa674bd49a"></span>
## 4.调用示例
...
<span class="anchor" id="db92442c-a705-4950-8dce-a5abe6f18fbe"></span>
## 5.FAQ
