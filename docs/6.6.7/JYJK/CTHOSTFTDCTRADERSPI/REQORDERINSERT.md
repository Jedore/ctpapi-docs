...
<span class="anchor" id="a6bad1fa-14e1-4f41-b557-d76676b05360"></span>
## 1.函数原型
<p>virtual int ReqOrderInsert(CThostFtdcInputOrderField *pInputOrder, int nRequestID) = 0;</p>
<span class="anchor" id="806aee6c-e1f1-4eb1-824c-10bc507c111a"></span>
## 2.参数
...
<span class="anchor" id="e5321066-3bc0-4a69-afeb-f6713a75879f"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="fba925bc-8fde-4d02-aefa-b5d87c476044"></span>
## 4.调用示例
<pre><code>//限价单:
...
<span class="anchor" id="32d3650d-173f-45ca-ba0f-c177cd89599e"></span>
## 5.FAQ
