...
<span class="anchor" id="0a1cee4e-5f5e-493f-b2dd-bc0d98857b43"></span>
## 1.函数原型
<p>virtual int ReqQuoteAction(CThostFtdcInputQuoteActionField *pInputQuoteAction, int nRequestID) = 0;</p>
<span class="anchor" id="8f841bf8-4269-4b45-98bf-0e95d77dc886"></span>
## 2.参数
...
<span class="anchor" id="ab74f566-8da2-4715-a6a8-322ac65f6d3a"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="67d35b55-f14e-4ee0-9dfb-5692470f482a"></span>
## 4.调用示例
...
<span class="anchor" id="c2551cae-6f16-4e46-8b26-daf79b69f33d"></span>
## 5.FAQ
<p>无</p>
