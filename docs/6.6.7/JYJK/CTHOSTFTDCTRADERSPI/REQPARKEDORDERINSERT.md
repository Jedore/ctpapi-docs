...
<span class="anchor" id="20be2871-b499-4407-a789-4dffe9b97961"></span>
## 1.函数原型
<p>virtual int ReqParkedOrderInsert(CThostFtdcParkedOrderField *pParkedOrder, int nRequestID) = 0;</p>
<span class="anchor" id="77f7398c-db5e-4354-bffc-31f183ace8ff"></span>
## 2.参数
...
<span class="anchor" id="b74b4356-0f3f-403c-a9c8-1b77e5b4386f"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="f3040d46-1eef-42fa-9365-3f3f9d328d10"></span>
## 4.调用示例
...
<span class="anchor" id="9c70d680-af25-44a0-95c0-667d34d659f1"></span>
## 5.FAQ
<p>无</p>
