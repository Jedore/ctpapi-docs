...
<span class="anchor" id="546fcbd2-1b8c-414c-a1ab-3ec520c9427a"></span>
## 1.函数原型
<p>virtual int ReqParkedOrderAction(CThostFtdcParkedOrderActionField *pParkedOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="737a0059-dff5-4fd3-a0bc-788b0e0e7bde"></span>
## 2.参数
...
<span class="anchor" id="79df2ea2-686b-4b91-80ac-ec7f9fbc452f"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="4ca0e17b-2956-42e7-a39c-04dc023fc9a7"></span>
## 4.调用示例
...
<span class="anchor" id="8ce6e967-d351-49d7-b62e-4ae6d3bd351f"></span>
## 5.FAQ
<p>无</p>
