...
<span class="anchor" id="fc4ac49e-3ef6-420f-9584-529815a16b3a"></span>
## 1.函数原型
...
<span class="anchor" id="beeabe44-4bcb-464c-8887-aabfe04ba58b"></span>
## 2.参数
...
<span class="anchor" id="49664fd2-d3ab-4ad1-9e01-907c1bed587f"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="9e4048c7-e643-47ca-aec9-eded88dd232d"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="a15b71db-4518-4f6a-bdd8-2a5a5a25f82a"></span>
## 5.FAQ
<p>无</p>
