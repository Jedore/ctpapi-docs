...
<span class="anchor" id="d7513497-ecd7-49ca-88de-a40c4a240110"></span>
## 1.函数原型
<p>virtual int ReqForQuoteInsert(CThostFtdcInputForQuoteField *pInputForQuote, int nRequestID) = 0;</p>
<span class="anchor" id="cc935b5b-ce20-4bb3-bdd3-c5369e44f2fc"></span>
## 2.参数
...
<span class="anchor" id="d6878048-0333-420e-a427-ce578b2c9c15"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="ea6adecc-55e6-4d3e-88a5-fde363f88677"></span>
## 4.调用示例
...
<span class="anchor" id="ef9cac15-0c2d-4f7a-a052-2a0d25867f85"></span>
## 5.FAQ
