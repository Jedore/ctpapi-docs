...
<span class="anchor" id="f1e78529-304d-454a-b4a5-0ed01a64ef1b"></span>
## 1.函数原型
<p>virtual int ReqQryOptionInstrCommRate(CThostFtdcQryOptionInstrCommRateField *pQryOptionInstrCommRate, int nRequestID) = 0;</p>
<span class="anchor" id="fe8477f3-924e-4152-84f5-27918a5ea47b"></span>
## 2.参数
...
<span class="anchor" id="2cec86ab-d4f8-4d71-bfbf-9cc862ede848"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="37e59b96-9055-4692-b533-de3dfd734ec5"></span>
## 4.调用示例
...
<span class="anchor" id="6b92bb4d-a635-449a-9eb8-b9735962f33c"></span>
## 5.FAQ
