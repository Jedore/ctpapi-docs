...
<span class="anchor" id="cd412805-d46a-4588-b50d-b05d5eb33f9a"></span>
## 1.函数原型
<p>virtual int ReqQryQuote(CThostFtdcQryQuoteField *pQryQuote, int nRequestID) = 0;</p>
<span class="anchor" id="8768f7e7-cbd4-489f-8bba-a26bcd952e70"></span>
## 2.参数
<p>pQryQuote：报价查询</p>
...
<span class="anchor" id="04607d0f-1cc3-4902-aaa5-eb616502a6a5"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="502db432-1c86-49c9-9152-4a08ce2be5d0"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="3d68a2c6-0023-4629-9191-030fa4360e64"></span>
## 5.FAQ
<p>无</p>
