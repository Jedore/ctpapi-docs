...
<span class="anchor" id="85f3b01e-daf1-4147-8f92-a0a7f045195d"></span>
## 1.函数原型
<p>virtual int ReqUserLoginWithOTP(CThostFtdcReqUserLoginWithOTPField *pReqUserLoginWithOTP, int nRequestID) = 0;</p>
<span class="anchor" id="64861557-699b-4c44-9010-10bb6bd885c1"></span>
## 2.参数
...
<span class="anchor" id="2778b1e1-9bf6-4711-b42a-071fd99e6f7a"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="17506e85-9c22-4624-9105-4a3442e8d22f"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="03e4485f-d843-4a95-8d95-d655fb58b25b"></span>
## 5.FAQ
<p>无</p>
