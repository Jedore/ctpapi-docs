...
<span class="anchor" id="3178d032-15aa-422e-be2f-9365795d5ca2"></span>
## 1.函数原型
<p>virtual int ReqQueryBankAccountMoneyByFuture(CThostFtdcReqQueryAccountField *pReqQueryAccount, int nRequestID) = 0;</p>
<span class="anchor" id="6a2dd6c4-1527-40e7-9162-315cb074ca02"></span>
## 2.参数
...
<span class="anchor" id="7af83af6-5ead-44ad-8ded-c583909bbb2e"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="a439431c-78a6-478e-a7ad-24cec8ca3a04"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="7670c786-2cdf-40de-a7cd-717ed91bcc75"></span>
## 5.FAQ
<p>无</p>
