...
<span class="anchor" id="a97033ea-da56-422e-b795-e51c1617a943"></span>
## 1.函数原型
<p>virtual int ReqOrderAction(CThostFtdcInputOrderActionField *pInputOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="84070b39-1e34-4b53-8403-90f619339184"></span>
## 2.参数
...
<span class="anchor" id="2f006a92-408a-4b3f-9ecc-940aea007647"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="25bf8142-8209-4332-a6fd-7b3b4e88c420"></span>
## 4.调用示例
...
<span class="anchor" id="8881ad0f-c0e1-4b41-911f-d4f995750861"></span>
## 5.FAQ
<p>无</p>
