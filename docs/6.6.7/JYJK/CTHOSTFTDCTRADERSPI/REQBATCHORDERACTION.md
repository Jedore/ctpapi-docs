...
<span class="anchor" id="3b41650a-5fe0-44f0-86ac-911918333047"></span>
## 1.函数原型
<p>virtual int ReqBatchOrderAction(CThostFtdcInputBatchOrderActionField *pInputBatchOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="a2bfa662-75a5-4cc2-9c0e-b47187318d75"></span>
## 2.参数
...
<span class="anchor" id="3625bee0-c737-4ad7-9a08-ad4156873cd2"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="b5f34193-31cf-4729-a78c-6527d51375c3"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="4e11b2cd-8e04-4807-8998-2326790bf5e9"></span>
## 5.FAQ
<p>无</p>
