...
<span class="anchor" id="11647118-c51f-46c5-91f1-bb7754115255"></span>
## 1.函数原型
<p>virtual int ReqQryMulticastInstrument(CThostFtdcQryMulticastInstrumentField *pQryMulticastInstrument, int nRequestID) = 0;</p>
<span class="anchor" id="45e70239-edf2-4d21-9cdf-288c8b9cb0a7"></span>
## 2.参数
...
<span class="anchor" id="d705ca67-cd95-4161-a284-fdb1a98a0aa6"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="652c92a7-7022-4dcf-9a98-36820dc508bd"></span>
## 4.调用示例
...
<span class="anchor" id="ac222694-1205-4a54-acb7-c56df6149c2f"></span>
## 5.FAQ
<p>无</p>
