...
<span class="anchor" id="0bc687a2-2996-4748-a1b0-5c3855abfab7"></span>
## 1. 兼容性
...
<span class="anchor" id="99c1e906-a6c9-4199-8344-333cdc8f00aa"></span>
## 2. 运行环境
...
<span class="anchor" id="df50f8da-7807-44d9-b084-3917ffd85534"></span>
## 3. API变动
<span class="anchor" id="da5a9283-e9ec-49b5-9ed3-5fc2decc9180"></span>
...
<span class="anchor" id="b792dffa-de05-4dbb-a30e-6485a45c877a"></span>
### 3.2. IPAddress字段增长
...
<p><a href="../HQJK/CTHOSTFTDCMDAPI/REGISTERFRONT/">RegisterFront</a>和<a href="../JYJK/CTHOSTFTDCTRADERSPI/REGISTERNAMESERVER/">RegisterNameServer</a>函数按照如下规则填写：</p>
<pre><code>FrontAddress=tcp://172.24.121.51:35001
FrontAddress=tcp6://fe80::20f8:aa9b:7d59:887d:35001
</code></pre>
<span class="anchor" id="07f2ce2a-ea08-42c2-82f4-9cdbfef19fa3"></span>
### 3.3. 新增查询大商所组合优惠参数接口
...
<span class="anchor" id="e46930a4-a1d4-4a89-ac8c-f8f376b43696"></span>
### 3.4. 新增组合枚举值
...
<span class="anchor" id="174fbe33-d1b7-4a1a-9b20-7ff8ba106ecb"></span>
### 3.5. 新增公有流可订阅和取消的功能
...
<span class="anchor" id="954b3466-aafd-4563-bad7-e811b5511ce7"></span>
### 3.6. 新增查询分类合约的接口
...
<span class="anchor" id="9fd095b8-acda-4e0d-aa72-49dc19e94661"></span>
### 3.7. 查询最大报单数量的接口名称修改
...
<span class="anchor" id="0a11de98-b1a3-4ad2-b1ac-c3bdfa57ac6f"></span>
### 3.8. 请求查询报价接口逻辑优化
...
<span class="anchor" id="dba0eaa8-4f72-4191-a3ae-04f19a6db55f"></span>
## 4. 看穿式采集库说明
