...
<span class="anchor" id="59912db3-021a-4193-b8e8-2e33ae99bb9d"></span>
## 1.函数原型
<p>virtual int ReqUserLogin(CThostFtdcReqUserLoginField *pReqUserLoginField, int nRequestID) = 0;</p>
<span class="anchor" id="23d19f97-8414-4a6b-8759-f4aca93f00a3"></span>
## 2.参数
...
<span class="anchor" id="7c061b25-7e07-4744-8e58-28f9b916c94f"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="e96c5843-596b-4335-be9f-59eafafe5d1d"></span>
## 4.调用示例
...
<span class="anchor" id="1c00621d-3b8b-45f5-98b4-cee963824ce0"></span>
## 5.FAQ
