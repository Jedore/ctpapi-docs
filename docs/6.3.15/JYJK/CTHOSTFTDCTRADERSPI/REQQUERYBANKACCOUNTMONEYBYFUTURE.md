...
<span class="anchor" id="c545cab5-55e8-4a27-a0f6-0a9ba3671c1d"></span>
## 1.函数原型
<p>virtual int ReqQueryBankAccountMoneyByFuture(CThostFtdcReqQueryAccountField *pReqQueryAccount, int nRequestID) = 0;</p>
<span class="anchor" id="5b59e242-0bb8-4f34-bcf8-89eb5cea9c69"></span>
## 2.参数
...
<span class="anchor" id="7c61cbbe-397a-411a-a913-b2ca4d3a03ee"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="1ae695a7-2c1a-4d37-86d6-90ca4047af8a"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="56c31649-5802-44ca-89de-9f435bca826a"></span>
## 5.FAQ
<p>无</p>
