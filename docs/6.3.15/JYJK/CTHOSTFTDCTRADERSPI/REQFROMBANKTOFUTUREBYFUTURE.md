...
<span class="anchor" id="1fe81fb4-a1ea-42b0-9a17-bd63fb83309e"></span>
## 1.函数原型
<p>virtual int ReqFromBankToFutureByFuture(CThostFtdcReqTransferField *pReqTransfer, int nRequestID) = 0;</p>
<span class="anchor" id="bacbe3d9-0520-427b-9a04-f7fd7f6ff5aa"></span>
## 2.参数
...
<span class="anchor" id="d1195c25-af09-43aa-9116-e72990a6e0eb"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="874a535b-9a57-48a9-bf0e-5a41f5fad4b2"></span>
## 4.调用示例
...
<span class="anchor" id="1f12489a-a295-47fa-b647-57a68add9fca"></span>
## 5.FAQ
<p>无</p>
