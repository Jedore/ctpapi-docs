...
<span class="anchor" id="79f5ee64-dc00-458d-b68f-cc01fa2d1158"></span>
## 1.函数原型
<p>virtual int ReqParkedOrderAction(CThostFtdcParkedOrderActionField *pParkedOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="03f7686b-7a5a-4aff-b573-d19daa562ffb"></span>
## 2.参数
...
<span class="anchor" id="c385970e-dbc7-438c-b4b7-9cedb03258a2"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="409caff4-a35d-4419-90f2-01c4f8b5c77f"></span>
## 4.调用示例
...
<span class="anchor" id="b7bbf4d3-3ad6-46d5-810f-4e4cb3b2a1ae"></span>
## 5.FAQ
<p>无</p>
