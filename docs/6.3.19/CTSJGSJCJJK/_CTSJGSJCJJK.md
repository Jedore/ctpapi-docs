...
<span class="anchor" id="5b723db1-b0d9-4019-ac13-7032ab5b9c42"></span>
## 1.定义
<table>
<tr>
...
<span class="anchor" id="5694f45c-2e79-4055-8e06-a1f0e279e4c9"></span>
## 2.说明
...
<span class="anchor" id="603dc393-36dd-496c-972a-87916180a40b"></span>
## 3.相关接口
<pre><code>///客户端认证请求
...
<span class="anchor" id="8c52d10b-0707-4a6b-895e-d84362266843"></span>
## 4.示例代码
<p><strong>每个类型的终端调用流程不同，请注意区分！</strong></p>
<span class="anchor" id="62e1436e-4aa0-4e3a-8c27-0aca980b65f4"></span>
### 4.1.直连终端的采集使用流程示例代码：
...
<span class="anchor" id="ae5f078e-9020-4545-bb9e-c527af81151f"></span>
### 4.2.多对多中继终端使用流程示例代码：
...
<span class="anchor" id="5df69daf-f3c4-43f5-ac74-cdbdd79764bc"></span>
### 4.3.一对多中继终端使用流程示例代码：
