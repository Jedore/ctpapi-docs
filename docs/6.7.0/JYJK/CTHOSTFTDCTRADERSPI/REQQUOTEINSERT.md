...
<span class="anchor" id="6dcdd99d-37c8-4f49-b67e-b7337d165e75"></span>
## 1.函数原型
<p>virtual int ReqQuoteInsert(CThostFtdcInputQuoteField *pInputQuote, int nRequestID) = 0;</p>
<span class="anchor" id="f4916247-24c1-4070-982b-07f565da0ded"></span>
## 2.参数
...
<span class="anchor" id="f2df0779-3529-4900-9b02-4aaf10df050b"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="061c63cc-961d-4711-9311-c641509b4899"></span>
## 4.示例调用
...
<span class="anchor" id="d3f718e0-32c8-4e75-9f16-f8430d50a2ce"></span>
## 5.FAQ
