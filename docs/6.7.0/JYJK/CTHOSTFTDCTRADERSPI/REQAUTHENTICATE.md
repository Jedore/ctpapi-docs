...
<span class="anchor" id="bac02131-ccfa-4620-ae76-33a8e98c1f95"></span>
## 1.函数原型
<p>virtual int ReqAuthenticate(CThostFtdcReqAuthenticateField *pReqAuthenticateField, int nRequestID) = 0;</p>
<span class="anchor" id="57a0fda7-f168-4ccd-a5c8-9684d29ff526"></span>
## 2.参数
...
<span class="anchor" id="478bd7c3-b680-40e4-8106-a1c6c5234742"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="4d8a0523-8d7b-4613-be05-888704d1e66a"></span>
## 4.调用示例
...
<span class="anchor" id="1187b81c-8ee3-4860-822e-fe5a56994e43"></span>
## 5.FAQ
