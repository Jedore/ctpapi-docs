...
<span class="anchor" id="e940ab65-f189-4d9a-b797-c25383b69714"></span>
## 1.函数原型
<p>virtual int ReqQryForQuote(CThostFtdcQryForQuoteField *pQryForQuote, int nRequestID) = 0;</p>
<span class="anchor" id="ab2b60df-a115-41b4-b02b-0cc4db21d625"></span>
## 2.参数
...
<span class="anchor" id="9375c801-3c71-4333-b1a4-b19672cd1d36"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="5bf9d3a5-65fe-49f5-972a-afeb6ebd4a88"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="886572a4-09d8-4cf7-beaa-34b3c35b2a16"></span>
## 5.FAQ
<p>无</p>
