...
<span class="anchor" id="43819384-0d21-45eb-a638-0d3c0e8d190f"></span>
## 1.函数原型
<p>virtual int ReqExecOrderInsert(CThostFtdcInputExecOrderField *pInputExecOrder, int nRequestID) = 0;</p>
<span class="anchor" id="d967a9fc-a874-4d50-846b-4d5b38809d5c"></span>
## 2.参数
...
<span class="anchor" id="7f891494-717e-40bc-85a2-04fc64d72312"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="6887e0c7-4da8-4b48-b2ac-1d8ab09b38b5"></span>
## 4.调用示例
...
<span class="anchor" id="cf838a6b-3b0c-45af-b8c4-4f49993667cc"></span>
## 5.FAQ
