...
<span class="anchor" id="2be207c2-47ea-45ec-a618-9e50949f1bbf"></span>
## 1.函数原型
<p>virtual int ReqForQuoteInsert(CThostFtdcInputForQuoteField *pInputForQuote, int nRequestID) = 0;</p>
<span class="anchor" id="97aac7b7-e89b-43b4-8fde-4d2802e04b54"></span>
## 2.参数
...
<span class="anchor" id="886a724f-c3f6-4421-8c0c-9a43d721ace7"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="d6c6b3db-962f-4d81-a953-7ae7d2c338f8"></span>
## 4.调用示例
...
<span class="anchor" id="8bb3deb9-ab42-4ba4-a71d-ed379e692936"></span>
## 5.FAQ
