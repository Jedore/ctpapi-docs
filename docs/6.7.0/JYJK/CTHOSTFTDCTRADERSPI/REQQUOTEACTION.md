...
<span class="anchor" id="db5e334f-9f8f-4986-91d5-e8cd5ba849ce"></span>
## 1.函数原型
<p>virtual int ReqQuoteAction(CThostFtdcInputQuoteActionField *pInputQuoteAction, int nRequestID) = 0;</p>
<span class="anchor" id="9a698189-0f30-412d-909c-2e19cb6385b9"></span>
## 2.参数
...
<span class="anchor" id="f6418927-1d1d-45f5-aec7-f10c8ed54cad"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="2ca3a202-cddf-49f7-ba02-eb7d0c7846fd"></span>
## 4.调用示例
...
<span class="anchor" id="709272ab-35bf-43e2-9280-3d78c25c96a2"></span>
## 5.FAQ
<p>无</p>
