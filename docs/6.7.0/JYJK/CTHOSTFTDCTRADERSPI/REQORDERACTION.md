...
<span class="anchor" id="d055a913-ff43-4f9d-bb0d-e1cd7cca32cc"></span>
## 1.函数原型
<p>virtual int ReqOrderAction(CThostFtdcInputOrderActionField *pInputOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="c6751a0c-a367-4587-8fb7-b4b0630455f7"></span>
## 2.参数
...
<span class="anchor" id="2bb19d44-4954-40e6-aef6-3930de2afcdc"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="a59ce281-b3a8-4ce5-afb4-04acd167dd19"></span>
## 4.调用示例
...
<span class="anchor" id="d39e0acb-aeaf-4965-971b-a81e2fa15ac9"></span>
## 5.FAQ
<p>无</p>
