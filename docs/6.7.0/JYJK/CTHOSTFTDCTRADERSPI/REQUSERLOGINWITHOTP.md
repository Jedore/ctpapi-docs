...
<span class="anchor" id="be3cc956-8ba7-4852-95d3-ebc8541fc6eb"></span>
## 1.函数原型
<p>virtual int ReqUserLoginWithOTP(CThostFtdcReqUserLoginWithOTPField *pReqUserLoginWithOTP, int nRequestID) = 0;</p>
<span class="anchor" id="3888dd28-8c4e-45e0-8b65-911f140dd7ca"></span>
## 2.参数
...
<span class="anchor" id="625318fe-020f-4df3-8284-e74e773cf730"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="e5790199-b937-4df3-85d0-fc3b5c71387c"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="9794b20d-1734-4afd-823e-a943c8c979d9"></span>
## 5.FAQ
<p>无</p>
