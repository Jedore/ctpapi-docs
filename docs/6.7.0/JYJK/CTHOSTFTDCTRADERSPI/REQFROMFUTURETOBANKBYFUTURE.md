...
<span class="anchor" id="e674613c-ec3b-46aa-8345-f2a2be312c38"></span>
## 1.函数原型
<p>virtual int ReqFromFutureToBankByFuture(CThostFtdcReqTransferField *pReqTransfer, int nRequestID) = 0;</p>
<span class="anchor" id="6e45962d-7ecd-463c-8d35-9c689475a666"></span>
## 2.参数
...
<span class="anchor" id="3b4be57c-a7d7-4d1c-8166-639731032b38"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="1cdfeb0b-8715-450c-a598-ad003cb5b72c"></span>
## 4.调用示例
...
<span class="anchor" id="17f2828b-a3ed-4b95-a2cc-0982b573dcb3"></span>
## 5.FAQ
<p>无</p>
