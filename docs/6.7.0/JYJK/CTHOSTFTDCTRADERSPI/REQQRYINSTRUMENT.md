...
<span class="anchor" id="33946f3c-a8eb-4e04-bd5a-dedd4e5694b8"></span>
## 1.函数原型
<p>virtual int ReqQryInstrument(CThostFtdcQryInstrumentField *pQryInstrument, int nRequestID) = 0;</p>
<span class="anchor" id="b9d9acbb-4814-4521-a962-b0dbe626ca9b"></span>
## 2.参数
...
<span class="anchor" id="3835a7cf-3e69-4880-8dee-2c3623738787"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="06272e25-e815-474b-9b62-acf2faedb86e"></span>
## 4.调用示例
...
<span class="anchor" id="40b7cc79-c126-4015-a2eb-5d3b6df79057"></span>
## 5.FAQ
