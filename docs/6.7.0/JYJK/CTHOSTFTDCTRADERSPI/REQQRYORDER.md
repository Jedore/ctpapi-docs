...
<span class="anchor" id="97a74f86-b2e6-4a71-a048-6df8ce299d10"></span>
## 1.函数原型
<p>virtual int ReqQryOrder(CThostFtdcQryOrderField *pQryOrder, int nRequestID) = 0;</p>
<span class="anchor" id="fecfd38a-3d3a-4741-b0a4-5e2a140dd42a"></span>
## 2.参数
<p>pQryOrder：查询报单</p>
...
<span class="anchor" id="555693df-a04f-4205-bff4-f28f901b12dc"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="ec3c55c5-db29-44d2-bf6a-95f1766a082f"></span>
## 4.调用示例
...
<span class="anchor" id="477f032a-1fd6-4405-a2bd-518758f1d5ce"></span>
## 5.FAQ
<p>无</p>
