...
<span class="anchor" id="886ca1a5-49bb-4c73-9107-b194868308d7"></span>
## 1.函数原型
<p>virtual int ReqUserLoginWithText(CThostFtdcReqUserLoginWithTextField *pReqUserLoginWithText, int nRequestID) = 0;</p>
<span class="anchor" id="40a860d8-b93c-4ce0-acbc-e9d0e70c0b9a"></span>
## 2.参数
...
<span class="anchor" id="a506aacb-0a9f-4a1c-bf01-b681720d6667"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="df0dd4ae-77b7-4212-acfd-9e3ab3c98e3c"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="0e50a23f-18a4-49c2-a486-8c106a5e222f"></span>
## 5.FAQ
<p>无</p>
