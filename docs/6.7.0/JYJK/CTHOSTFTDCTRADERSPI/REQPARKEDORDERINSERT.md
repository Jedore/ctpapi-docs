...
<span class="anchor" id="baa412ed-e0d4-4b9f-8ee1-cb479b7a02be"></span>
## 1.函数原型
<p>virtual int ReqParkedOrderInsert(CThostFtdcParkedOrderField *pParkedOrder, int nRequestID) = 0;</p>
<span class="anchor" id="75384d75-66c9-4b90-beac-d73a33886ccd"></span>
## 2.参数
...
<span class="anchor" id="3e008836-6f62-4b44-91a6-6468ef1cf7ca"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="8d82cafd-51ae-42a0-b221-2b79a2888bf5"></span>
## 4.调用示例
...
<span class="anchor" id="d5da0adc-202d-4bce-8e62-9ae7236a9036"></span>
## 5.FAQ
<p>无</p>
