...
<span class="anchor" id="6281cbf2-4cc3-4acc-964c-676cf0a8b2df"></span>
## 1.函数原型
...
<span class="anchor" id="599524b3-84fd-42c3-8f09-42c8fd2cfb6b"></span>
## 2.参数
...
<span class="anchor" id="fc7f1a5a-f9c7-4979-9072-90f706602904"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="6cff0078-0ee7-4425-8379-3bfd8dcd4a4b"></span>
## 4.调用示例
...
<span class="anchor" id="f5fff908-f3c8-49bd-b3ba-ea2302198ecb"></span>
## 5.FAQ
