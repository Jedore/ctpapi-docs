...
<span class="anchor" id="7559e416-8f3f-4fda-8cd6-99e097ba0587"></span>
## 1.函数原型
<p>virtual int ReqQrySecAgentACIDMap(CThostFtdcQrySecAgentACIDMapField *pQrySecAgentACIDMap, int nRequestID) = 0;</p>
<span class="anchor" id="48772b1c-78b7-4634-8efd-d383e37874da"></span>
## 2.参数
...
<span class="anchor" id="bf7886b6-62fc-4d59-81bd-fc828f49698d"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="b0b66e40-5537-4b36-9870-1b6fbe77a407"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="04c69a5b-86f8-40c4-a48e-2b2d4530f549"></span>
## 5.FAQ
<p>无</p>
