...
<span class="anchor" id="1d7f027f-d2d4-40ed-a030-5ff6b7bc1360"></span>
## 1.函数原型
<p>virtual int ReqQrySettlementInfo(CThostFtdcQrySettlementInfoField *pQrySettlementInfo, int nRequestID) = 0;</p>
<span class="anchor" id="bc21b6a8-8ecd-40ab-ba4a-d7667185a4db"></span>
## 2.参数
...
<span class="anchor" id="99f87062-da77-4a10-b279-a6d6c6ffb0fa"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="e10c5520-4c11-4916-94d2-efef56f11f5c"></span>
## 4.调用示例
...
<span class="anchor" id="37b63898-7b00-4700-aaa2-c2a94073de17"></span>
## 5.FAQ
