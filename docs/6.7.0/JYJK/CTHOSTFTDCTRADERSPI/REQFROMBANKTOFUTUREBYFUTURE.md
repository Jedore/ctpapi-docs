...
<span class="anchor" id="e059d70a-109e-4a93-9a99-8d7efaab13b7"></span>
## 1.函数原型
<p>virtual int ReqFromBankToFutureByFuture(CThostFtdcReqTransferField *pReqTransfer, int nRequestID) = 0;</p>
<span class="anchor" id="55746756-37a6-4f66-8409-eedb8e1a1c08"></span>
## 2.参数
...
<span class="anchor" id="bc78c6b4-6685-43b6-b616-16f80a4838c9"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="ef4ab48c-e621-4249-982f-603b5cf2a038"></span>
## 4.调用示例
...
<span class="anchor" id="e00fe720-0635-4ca3-a24b-7f823bb91ad5"></span>
## 5.FAQ
<p>无</p>
