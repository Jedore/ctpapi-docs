...
<span class="anchor" id="ad0d6bbb-cecd-456d-a38e-71c76114d04b"></span>
## 1.函数原型
<p>virtual int ReqParkedOrderAction(CThostFtdcParkedOrderActionField *pParkedOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="598fd451-0ac2-4577-8a1a-3a6c3dad43b2"></span>
## 2.参数
...
<span class="anchor" id="eaa549e1-2910-45b4-a662-d4da5e719cee"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="216512ee-742b-4373-9d1d-e7ee4d86818c"></span>
## 4.调用示例
...
<span class="anchor" id="7fc7ec53-2a6d-4d98-97dd-06feac957fe3"></span>
## 5.FAQ
<p>无</p>
