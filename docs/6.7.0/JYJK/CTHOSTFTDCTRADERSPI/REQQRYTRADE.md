...
<span class="anchor" id="be271482-3ec4-43e7-999d-40dfbd5049e2"></span>
## 1.函数原型
<p>virtual int ReqQryTrade(CThostFtdcQryTradeField *pQryTrade, int nRequestID) = 0;</p>
<span class="anchor" id="22003e92-4f06-4941-afe9-f6422cd5b42a"></span>
## 2.参数
<p>pQryTrade：查询成交</p>
...
<span class="anchor" id="ad40f4c5-abea-4523-84a2-b6e68b3f3748"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="f922803e-b95d-4daa-aee9-34a94f954671"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="a418a97a-a615-4583-8793-1308e92a6466"></span>
## 5.FAQ
<p>无</p>
