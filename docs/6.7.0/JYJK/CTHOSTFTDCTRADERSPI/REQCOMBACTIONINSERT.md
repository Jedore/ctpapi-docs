...
<span class="anchor" id="427338b0-4125-41d0-a4ca-af54845f7bdd"></span>
## 1.函数原型
<p>virtual int ReqCombActionInsert(CThostFtdcInputCombActionField *pInputCombAction, int nRequestID) = 0;</p>
<span class="anchor" id="553d9465-00ad-478c-9858-ed697b3acb38"></span>
## 2.参数
...
<span class="anchor" id="b9400ec7-33ec-4f0b-b38f-108965bb4938"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="eaee8f6d-8628-4aa4-b8bd-a60f2df658aa"></span>
## 4.调用示例
...
<span class="anchor" id="73493b19-b7b0-4c49-b9ad-6abbdddb69be"></span>
## 5.FAQ
<p>无</p>
