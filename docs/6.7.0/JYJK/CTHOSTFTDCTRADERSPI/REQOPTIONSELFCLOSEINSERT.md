...
<span class="anchor" id="6d3165c7-b6c3-41db-aca7-5dcb8cc25dbe"></span>
## 1.函数原型
<p>virtual int ReqOptionSelfCloseInsert(CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose, int nRequestID) = 0;</p>
<span class="anchor" id="d4265b1c-ee7b-4254-9e10-c77342e82c7f"></span>
## 2.参数
...
<span class="anchor" id="ee732576-518b-4c15-9746-94d3449f75b4"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="6eba680c-c7be-43d1-9527-bfb804afb89e"></span>
## 4.调用示例
...
<span class="anchor" id="2cd3f686-3fda-4616-ab24-ef4e886f6cd7"></span>
## 5.FAQ
