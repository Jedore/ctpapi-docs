...
<span class="anchor" id="13d313cc-2285-41c9-a34c-b22f3fc4aca2"></span>
## 1.函数原型
<p>virtual int ReqOrderInsert(CThostFtdcInputOrderField *pInputOrder, int nRequestID) = 0;</p>
<span class="anchor" id="0cd1d8f8-b90b-4e60-8d53-1aa8078beb04"></span>
## 2.参数
...
<span class="anchor" id="f9cc1eba-4c01-4cbe-a352-1c22d801550f"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="12f5ea6a-5b9c-4254-b0d9-791753e79a11"></span>
## 4.调用示例
<pre><code>//限价单:
...
<span class="anchor" id="443d7f84-26dc-4da7-874a-4923f63d7ba2"></span>
## 5.FAQ
