...
<span class="anchor" id="3e07968b-d524-4962-ba5b-1bdba5439675"></span>
## 1.函数原型
<p>virtual int ReqQryCombAction(CThostFtdcQryCombActionField *pQryCombAction, int nRequestID) = 0;</p>
<span class="anchor" id="eb7ad335-83e1-49d5-a8c6-ff9c48c7e109"></span>
## 2.参数
...
<span class="anchor" id="28c40096-2058-47d7-a911-4814d8ae33a7"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="db5db8db-0d70-44fd-9fde-f955a446c953"></span>
## 4.调用示例
...
<span class="anchor" id="0f13c55a-d094-4dca-a9c4-918d98ac9f97"></span>
## 5.FAQ
<p>无</p>
