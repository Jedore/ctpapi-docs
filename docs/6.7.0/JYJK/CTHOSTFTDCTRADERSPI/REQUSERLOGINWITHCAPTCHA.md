...
<span class="anchor" id="8b80c8fe-2e3a-414e-ace8-53fa8317c8d9"></span>
## 1.函数原型
<p>virtual int ReqUserLoginWithCaptcha(CThostFtdcReqUserLoginWithCaptchaField *pReqUserLoginWithCaptcha, int nRequestID) = 0;</p>
<span class="anchor" id="d2539dde-61e2-4d3f-acec-a7b98a8a5204"></span>
## 2.参数
...
<span class="anchor" id="ff368ed0-7ac4-49a2-bb77-ee209174b905"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="c2329b83-dbdb-496a-9530-525e66438936"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="e174928b-1da4-4d80-b9b3-e9154eb8f46e"></span>
## 5.FAQ
<p>无</p>
