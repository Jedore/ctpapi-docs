<p>期货发起冲正期货转银行请求，银行处理完毕后报盘发回的通知，一般冲正请求由ctp自动发起，无Req属于私有流回报</p>
<span class="anchor" id="ec4bc119-de75-4505-97d5-759c29f90912"></span>
## 1.函数原型
<p>virtual void OnRtnRepealFromFutureToBankByFuture(CThostFtdcRspRepealField *pRspRepeal) {};</p>
<span class="anchor" id="99c09c07-47f7-40d2-9cbf-96398d3a5d65"></span>
## 2.参数
<p>pRspRepeal：冲正响应</p>
...
<span class="anchor" id="8a14f117-5bfa-424f-a6d9-13d5ef9d1843"></span>
## 3.返回
<p>无</p>
<span class="anchor" id="e3768b45-5513-469e-a7ef-395f57b55173"></span>
## 4.FAQ
<p>无</p>
