...
<span class="anchor" id="5d3f09db-7268-479d-bedf-3567c27cb172"></span>
## 1.函数原型
<p>int CTP_GetSystemInfo(char* pSystemInfo, int&amp; nLen);</p>
<span class="anchor" id="931be88b-76d9-4a7c-9641-09fb802a8390"></span>
## 2.参数
...
<span class="anchor" id="d084d6cd-49f3-46f0-a404-a73553329ed7"></span>
## 3.返回
<p>0 为正确，非0为错误。</p>
...
<span class="anchor" id="a8df7661-69e2-420b-ba3e-940e67262421"></span>
## 4.调用示例
<pre><code>char pSystemInfo[344];
int len;
CTP_GetSystemInfo(pSystemInfo, len);
</code></pre>
<span class="anchor" id="e1d0108a-ee30-4ca5-b895-ea139ad0c247"></span>
## 5.FAQ
