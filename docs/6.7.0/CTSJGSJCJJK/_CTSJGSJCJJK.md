...
<span class="anchor" id="fd183c84-57a9-4533-bbf3-eafd14eab0db"></span>
## 1.定义
<table>
<tr>
...
<span class="anchor" id="d85e6008-7e6f-441c-bc48-3f549864adca"></span>
## 2.说明
...
<span class="anchor" id="7369e215-003d-4022-914e-e4bf788be9b1"></span>
## 3.权限要求
<p>采集库需要u+s权限</p>
<span class="anchor" id="a5342713-85cf-417c-b7f8-1d9e34a248e3"></span>
## 4.相关接口
<pre><code>///客户端认证请求
...
<span class="anchor" id="06d697d4-1d68-416e-aec8-e57a50e4399d"></span>
## 5.示例代码
<p><strong>每个类型的终端调用流程不同，请注意区分！</strong></p>
<span class="anchor" id="091f7e06-2cf5-41c3-aca8-5a38b1e702cd"></span>
### 5.1.直连终端的采集使用流程示例代码：
...
<span class="anchor" id="94452c17-d0cf-459c-a91f-b65f24008462"></span>
### 5.2.多对多中继终端使用流程示例代码：
...
<span class="anchor" id="142d14d1-94c1-4389-8ee6-3839eab5ffcb"></span>
### 5.3.一对多中继终端使用流程示例代码：
