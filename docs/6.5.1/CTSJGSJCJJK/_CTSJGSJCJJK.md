...
<span class="anchor" id="ef33abfe-11b5-405a-9013-e67d8907882e"></span>
## 1.定义
<table>
<tr>
...
<span class="anchor" id="8b50e5c1-aa31-4d3c-9e26-a51ed9ce2406"></span>
## 2.说明
...
<span class="anchor" id="828ee8cb-3c04-4384-ae1a-964343b61963"></span>
## 3.相关接口
<pre><code>///客户端认证请求
...
<span class="anchor" id="3135741c-c43e-438a-af39-431fb14dfd42"></span>
## 4.示例代码
<p><strong>每个类型的终端调用流程不同，请注意区分！</strong></p>
<span class="anchor" id="ff751e0f-4bed-4141-ba60-6aa7a4246916"></span>
### 4.1.直连终端的采集使用流程示例代码：
...
<span class="anchor" id="6e1b202c-a321-412a-bb3a-8bd2d04d0fc3"></span>
### 4.2.多对多中继终端使用流程示例代码：
...
<span class="anchor" id="d6020e57-f124-4cf1-b559-80153ca9bd0f"></span>
### 4.3.一对多中继终端使用流程示例代码：
