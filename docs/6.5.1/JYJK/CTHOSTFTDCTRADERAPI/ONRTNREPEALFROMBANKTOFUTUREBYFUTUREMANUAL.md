<p>系统运行时期货端手工发起冲正银行转期货请求，银行处理完毕后报盘发回的通知，无Req属于私有流回报</p>
<span class="anchor" id="f0bd9615-7b27-483f-a38e-23cea5ebebbf"></span>
## 1.函数原型
<p>virtual void OnRtnRepealFromBankToFutureByFutureManual(CThostFtdcRspRepealField *pRspRepeal) {};</p>
<span class="anchor" id="608eff9c-d83e-46dd-b9f3-a7a415662e47"></span>
## 2.参数
<p>pRspRepeal：冲正响应</p>
...
<span class="anchor" id="ed641188-5e21-421c-920c-4d5e505ea2ff"></span>
## 3.返回
<p>无</p>
<span class="anchor" id="715a3b99-afec-436b-a0ef-4436daaac239"></span>
## 4.FAQ
<p>无</p>
