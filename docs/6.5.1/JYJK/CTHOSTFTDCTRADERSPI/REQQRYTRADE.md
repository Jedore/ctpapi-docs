...
<span class="anchor" id="efb96836-81ed-4136-8c28-a01180a1b546"></span>
## 1.函数原型
<p>virtual int ReqQryTrade(CThostFtdcQryTradeField *pQryTrade, int nRequestID) = 0;</p>
<span class="anchor" id="3a6c8bbd-6f2d-435b-9ffa-bfdab94cf46d"></span>
## 2.参数
<p>pQryTrade：查询成交</p>
...
<span class="anchor" id="62ce5f37-24a2-450e-a09e-de9b9502cd9f"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="408c16fd-b205-4e40-809c-35faf8280387"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="ecfa218e-e9ef-4821-a575-21dc10ce4cb7"></span>
## 5.FAQ
<p>无</p>
