...
<span class="anchor" id="9c7cc6d1-e754-4187-ad4c-73801bab1a9a"></span>
## 1.函数原型
<p>virtual int ReqQueryBankAccountMoneyByFuture(CThostFtdcReqQueryAccountField *pReqQueryAccount, int nRequestID) = 0;</p>
<span class="anchor" id="a027526c-15fa-48f7-bc78-b67c704cbe68"></span>
## 2.参数
...
<span class="anchor" id="f50b5ae0-2d22-4c4f-a717-930bf19a1917"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="2e87e2cb-d955-49c0-80ef-3afed17489e6"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="6a0c4b6b-8a9a-4ef2-b721-50e5e8071cb8"></span>
## 5.FAQ
<p>无</p>
