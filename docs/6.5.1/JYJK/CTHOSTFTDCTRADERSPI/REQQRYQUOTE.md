...
<span class="anchor" id="7fdc1a94-849d-4edb-aac4-f12ea05fe13b"></span>
## 1.函数原型
<p>virtual int ReqQryQuote(CThostFtdcQryQuoteField *pQryQuote, int nRequestID) = 0;</p>
<span class="anchor" id="57d9f5f5-be15-45c2-85cb-7d7ef679b62d"></span>
## 2.参数
<p>pQryQuote：报价查询</p>
...
<span class="anchor" id="c00d2ec6-f995-49cc-b056-a696fa9c48b4"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="72b7bff2-4ac8-4a09-bfc7-4cc2779effe6"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="005f8d5c-2e8c-463a-aa25-5b28971b40cb"></span>
## 5.FAQ
<p>无</p>
