...
<span class="anchor" id="0885651f-d674-4c1f-84b9-4caa1046d04d"></span>
## 1.函数原型
<p>virtual int ReqQryInstrument(CThostFtdcQryInstrumentField *pQryInstrument, int nRequestID) = 0;</p>
<span class="anchor" id="fdc5b00a-6502-4946-97a5-59d452eaef97"></span>
## 2.参数
...
<span class="anchor" id="0d632b8b-5cb3-44cc-ac03-4d397bfa66e8"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="2663109c-6b1d-4442-a164-b2db16548cd8"></span>
## 4.调用示例
...
<span class="anchor" id="9fa8436a-4298-4965-a553-a90764f13d3d"></span>
## 5.FAQ
