...
<p>正确响应：OnRtnOrder</p>
<span class="anchor" id="24640af8-e858-4573-ad38-28c7808b7eb5"></span>
## 1.函数原型
<p>virtual int ReqOrderAction(CThostFtdcInputOrderActionField *pInputOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="cea50b50-a5ca-43ce-bc66-db8de11b79a1"></span>
## 2.参数
...
<span class="anchor" id="e510deaa-414d-4b2d-829d-1d38b2fe7437"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="a74ae0cf-f002-4159-ab82-36e032dddee1"></span>
## 4.调用示例
...
<span class="anchor" id="61bbf623-65c0-4068-99f5-4caafd5669ec"></span>
## 5.FAQ
<p>无</p>
