...
<span class="anchor" id="b8f877a9-c165-472d-8e59-ceb9fa74928b"></span>
## 1.函数原型
<p>virtual int ReqExecOrderInsert(CThostFtdcInputExecOrderField *pInputExecOrder, int nRequestID) = 0;</p>
<span class="anchor" id="8c12131a-8ed1-4ffd-9dfa-40e5d0ee6928"></span>
## 2.参数
...
<span class="anchor" id="70c423be-68e4-48b8-adea-5fafbb147f00"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="1eb68c55-8747-4299-b716-dbf877009f2c"></span>
## 4.调用示例
...
<span class="anchor" id="f5a61f18-08fb-4b18-ac20-3eda2a37fe11"></span>
## 5.FAQ
<p>无</p>
