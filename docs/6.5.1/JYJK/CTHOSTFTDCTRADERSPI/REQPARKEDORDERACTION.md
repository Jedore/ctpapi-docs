...
<span class="anchor" id="54222076-2e70-4461-bd45-9d3ff359ace3"></span>
## 1.函数原型
<p>virtual int ReqParkedOrderAction(CThostFtdcParkedOrderActionField *pParkedOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="48abb9ea-039b-4603-a76e-9652572da197"></span>
## 2.参数
...
<span class="anchor" id="2b85451e-4ba6-45f2-b671-a695fee2dff9"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="783267c5-004f-4ee4-91e9-096784d3a6c4"></span>
## 4.调用示例
...
<span class="anchor" id="b9466f76-bf00-4461-a676-085725422db0"></span>
## 5.FAQ
<p>无</p>
