...
<span class="anchor" id="d34c1134-83d7-4222-affb-55255ed04dc4"></span>
## 1.函数原型
<p>virtual int RegisterUserSystemInfo(CThostFtdcUserSystemInfoField *pUserSystemInfo) = 0;</p>
<span class="anchor" id="fe1cf1f2-d24a-4ce2-90a9-bcd80790a4b1"></span>
## 2.参数
...
<span class="anchor" id="796782fd-b792-46ca-bc0c-aa385c42ac6f"></span>
## 3.返回
<p>0 正确</p>
<p>-1 字段长度不对</p>
<p>-2 非CTP采集的终端信息</p>
...
<p>-6 采集结果字段错误</p>
<span class="anchor" id="56fe8c36-cbd1-4879-a362-d8cd6d724610"></span>
## 4.调用示例
<p>//多对多中继终端使用流程</p>
...
<span class="anchor" id="4fda735e-59bd-4517-a271-d4f912accf1c"></span>
## 5.FAQ
