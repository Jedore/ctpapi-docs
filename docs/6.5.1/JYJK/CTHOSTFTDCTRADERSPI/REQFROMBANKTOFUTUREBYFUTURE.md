...
<span class="anchor" id="2fc0a6b0-28d8-49fd-ba7f-311b404e99c9"></span>
## 1.函数原型
<p>virtual int ReqFromBankToFutureByFuture(CThostFtdcReqTransferField *pReqTransfer, int nRequestID) = 0;</p>
<span class="anchor" id="e39e2258-d53b-4f71-ae3e-03a02d92cb5b"></span>
## 2.参数
...
<span class="anchor" id="3d0f6a56-9f3f-4303-9e75-8a01b2275158"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="3943acb9-1477-46c4-bbd2-b1da42033393"></span>
## 4.调用示例
...
<span class="anchor" id="cae43e44-0051-4a09-922f-a967d570e55f"></span>
## 5.FAQ
<p>无</p>
