...
<span class="anchor" id="bfaca883-d73b-49c2-a7e1-1b234d62b8e4"></span>
## 1.函数原型
<p>virtual int ReqQryOrder(CThostFtdcQryOrderField *pQryOrder, int nRequestID) = 0;</p>
<span class="anchor" id="4d810f75-116b-469a-84db-3f5f1ab349ef"></span>
## 2.参数
<p>pQryOrder：查询报单</p>
...
<span class="anchor" id="639b5320-dffe-423f-9cd6-54cff9b9369e"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="7dc90d60-e567-46c8-adb0-d281ad669a43"></span>
## 4.调用示例
...
<span class="anchor" id="8d2401f5-c1ea-40dd-96a0-27650a3d118d"></span>
## 5.FAQ
<p>无</p>
