...
<span class="anchor" id="f9bb9f69-2a99-4542-8532-05b3e46277e4"></span>
## 1.函数原型
<p>virtual int ReqUserLogout(CThostFtdcUserLogoutField *pUserLogout, int nRequestID) = 0;</p>
<span class="anchor" id="65af7096-ff6f-468e-b206-110a82e985c9"></span>
## 2.参数
...
<span class="anchor" id="c75f48c2-5ee3-4ca2-b721-297c6523c5d9"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="0bb6663d-ffd9-4f09-8e37-86aec7beb7e0"></span>
## 4.调用示例
...
<span class="anchor" id="2befade3-51ba-42a4-9cd4-f760f1d0a5be"></span>
## 5.FAQ
