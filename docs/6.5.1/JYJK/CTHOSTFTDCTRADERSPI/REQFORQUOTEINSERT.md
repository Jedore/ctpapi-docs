...
<span class="anchor" id="ad93d21f-12f1-4790-9dcb-e34f28d50924"></span>
## 1.函数原型
<p>virtual int ReqForQuoteInsert(CThostFtdcInputForQuoteField *pInputForQuote, int nRequestID) = 0;</p>
<span class="anchor" id="e644708a-e34e-42c3-8301-48482fb4cc62"></span>
## 2.参数
...
<span class="anchor" id="a48a5b56-42c1-49fd-9455-28d374eb6d14"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="8eadee26-431d-40bd-85c5-840d730223c9"></span>
## 4.调用示例
...
<span class="anchor" id="8226dd74-43d6-4ee8-9350-7bfb8b997cea"></span>
## 5.FAQ
