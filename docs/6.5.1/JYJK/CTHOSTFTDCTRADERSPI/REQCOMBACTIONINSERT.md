...
<span class="anchor" id="4e09c5e6-2dbb-41ad-aa53-569e85c59f82"></span>
## 1.函数原型
<p>virtual int ReqCombActionInsert(CThostFtdcInputCombActionField *pInputCombAction, int nRequestID) = 0;</p>
<span class="anchor" id="6341f864-6528-446d-88fb-5a4acadbca30"></span>
## 2.参数
...
<span class="anchor" id="ce39921c-5c8b-43a6-a2ae-b8f091143a45"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="9c90f63c-573b-45d8-b0d0-ddf657c6d07a"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="dd0cbf05-24f5-4aac-bffe-b0c98fee8303"></span>
## 5.FAQ
<p>无</p>
