...
<span class="anchor" id="591c3786-aec2-4b78-99e9-dd0f44e6239b"></span>
## 1.函数原型
<p>virtual int ReqQuoteAction(CThostFtdcInputQuoteActionField *pInputQuoteAction, int nRequestID) = 0;</p>
<span class="anchor" id="27272d91-0e6e-482b-b962-9c981e4f2bb4"></span>
## 2.参数
...
<span class="anchor" id="45b9f99c-010b-4c97-9562-2b78516c138d"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="532a49aa-df21-43bf-bd0e-308d53ac7481"></span>
## 4.调用示例
...
<span class="anchor" id="3eda6a06-75bf-4757-af48-17f53fe7c6e2"></span>
## 5.FAQ
<p>无</p>
