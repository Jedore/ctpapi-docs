...
<span class="anchor" id="3fdda61f-027e-4e46-a987-2d49fb6554c8"></span>
## 1.函数原型
<p>virtual int ReqQrySettlementInfo(CThostFtdcQrySettlementInfoField *pQrySettlementInfo, int nRequestID) = 0;</p>
<span class="anchor" id="38ff2e59-eb9a-47b0-a825-9231a61ee3d1"></span>
## 2.参数
...
<span class="anchor" id="2abddb47-08f0-4dfe-ab05-499a2baef4b2"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="1c74099d-00db-47be-97f7-2b6ac42611a6"></span>
## 4.调用示例
...
<span class="anchor" id="cd40f25b-1607-4476-b3c3-9977a1430735"></span>
## 5.FAQ
