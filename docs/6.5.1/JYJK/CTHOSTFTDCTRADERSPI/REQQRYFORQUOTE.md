...
<span class="anchor" id="2d9c871a-c1e3-410a-80db-4d60fc01d344"></span>
## 1.函数原型
<p>virtual int ReqQryForQuote(CThostFtdcQryForQuoteField *pQryForQuote, int nRequestID) = 0;</p>
<span class="anchor" id="f8709578-65e9-4de2-927f-a342bc7304fa"></span>
## 2.参数
...
<span class="anchor" id="0620fd2d-71c0-46c6-aace-52624ff83c51"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="cf07880a-802b-45c7-8113-615405382eb8"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="854a29f9-3043-4516-92c4-5aae0fcc9bda"></span>
## 5.FAQ
<p>无</p>
