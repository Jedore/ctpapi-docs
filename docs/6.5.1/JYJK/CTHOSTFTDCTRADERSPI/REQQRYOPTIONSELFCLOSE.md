...
<span class="anchor" id="9da818a6-121d-406f-a91b-a9630260a11b"></span>
## 1.函数原型
<p>virtual int ReqQryOptionSelfClose(CThostFtdcQryOptionSelfCloseField *pQryOptionSelfClose, int nRequestID) = 0;</p>
<span class="anchor" id="74aabd3c-76ee-42de-bdb1-1653a76db21a"></span>
## 2.参数
...
<span class="anchor" id="df8fc8c6-2a42-4e05-af03-0daaca9ada9c"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="11e16e11-c1db-4b1c-ab0d-3f3fd63dddbc"></span>
## 4.调用示例
...
<span class="anchor" id="1b3318c6-6166-40e5-8ddb-9540f2b9c572"></span>
## 5.FAQ
<p>无</p>
