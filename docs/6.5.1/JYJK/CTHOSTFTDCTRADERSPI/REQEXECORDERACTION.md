...
<span class="anchor" id="2b823158-fc0e-4c8a-b21a-70d7e7a65608"></span>
## 1.函数原型
<p>virtual int ReqExecOrderAction(CThostFtdcInputExecOrderActionField *pInputExecOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="61587248-fab5-4300-aadd-5322d651101a"></span>
## 2.参数
...
<span class="anchor" id="6de8a001-1155-4249-8e08-023341ffc117"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="271e602a-b383-4883-a965-82a40670913b"></span>
## 4.调用示例
...
<span class="anchor" id="d5fec8ba-8fce-4092-9b10-74fb913ec116"></span>
## 5.FAQ
<p>无</p>
