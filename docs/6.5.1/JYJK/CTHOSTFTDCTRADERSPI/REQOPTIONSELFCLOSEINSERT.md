...
<span class="anchor" id="3c6266d8-95cf-4d45-b990-ec5ca13e8189"></span>
## 1.函数原型
<p>virtual int ReqOptionSelfCloseInsert(CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose, int nRequestID) = 0;</p>
<span class="anchor" id="801eba77-8a4a-452e-b545-4de487aa103e"></span>
## 2.参数
...
<span class="anchor" id="c76e86cc-8956-4e51-8682-65326360efb5"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="b1b2cbbc-7b5e-4eb1-8897-ce6639967b9d"></span>
## 4.调用示例
...
<span class="anchor" id="a70bd3f8-3525-49b9-9eb5-0eeda88f3784"></span>
## 5.FAQ
