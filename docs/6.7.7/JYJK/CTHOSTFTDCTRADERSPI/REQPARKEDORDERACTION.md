...
<span class="anchor" id="15ef5ede-d94f-4338-b9d5-69fab2c4abb0"></span>
## 1.函数原型
<p>virtual int ReqParkedOrderAction(CThostFtdcParkedOrderActionField *pParkedOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="2eaafba8-3cbf-41bd-aa2d-702af24615ce"></span>
## 2.参数
...
<span class="anchor" id="ad8f1978-9cd3-4245-989e-feddab22dc18"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="6163f16d-bf75-49b5-bdff-10928540f267"></span>
## 4.调用示例
...
<span class="anchor" id="4fbe16dd-4c31-4f33-8ecd-4004fe83ce83"></span>
## 5.FAQ
<p>无</p>
