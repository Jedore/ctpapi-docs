...
<span class="anchor" id="2e6bfa3e-41b1-443c-b67d-44ce0c97547b"></span>
## 1.函数原型
<p>virtual int ReqQryForQuote(CThostFtdcQryForQuoteField *pQryForQuote, int nRequestID) = 0;</p>
<span class="anchor" id="0da61c0d-184a-4594-a87f-9cca70198e3e"></span>
## 2.参数
...
<span class="anchor" id="5897ecc2-d9e9-4ab6-83dc-d40ea3036c49"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="5e525079-01a2-4a54-8fe0-5ed428ca10dc"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="7e1c5413-36d2-4edd-be49-fcf8f688fb53"></span>
## 5.FAQ
<p>无</p>
