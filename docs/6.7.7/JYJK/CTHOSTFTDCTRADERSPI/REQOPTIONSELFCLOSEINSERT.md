...
<span class="anchor" id="9c035bab-ae56-405b-a963-a8fa473e02bb"></span>
## 1.函数原型
<p>virtual int ReqOptionSelfCloseInsert(CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose, int nRequestID) = 0;</p>
<span class="anchor" id="4ff64f8e-aade-45f9-ab35-7a68ec72fc2a"></span>
## 2.参数
...
<span class="anchor" id="2026ce91-7fc8-4c7b-883e-924267030477"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="73e81dcd-fe33-4e4b-906a-eddac073b56c"></span>
## 4.调用示例
...
<span class="anchor" id="eb0755c0-280b-4a80-931b-59427b6916e8"></span>
## 5.FAQ
