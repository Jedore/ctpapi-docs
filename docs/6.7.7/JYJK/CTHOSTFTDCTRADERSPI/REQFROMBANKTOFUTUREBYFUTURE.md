...
<span class="anchor" id="eaba4aad-e1ff-4e57-9465-8b111ab48607"></span>
## 1.函数原型
<p>virtual int ReqFromBankToFutureByFuture(CThostFtdcReqTransferField *pReqTransfer, int nRequestID) = 0;</p>
<span class="anchor" id="7bf137c6-2701-4df8-b2c1-3806a2e8f762"></span>
## 2.参数
...
<span class="anchor" id="022ddd23-7091-4c10-b219-52fd6188e53f"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="64d1f00d-fbd4-4bd6-91aa-2f6ff94b26d8"></span>
## 4.调用示例
...
<span class="anchor" id="8317de59-2ecd-4d06-8dfb-02210b46e338"></span>
## 5.FAQ
<p>无</p>
