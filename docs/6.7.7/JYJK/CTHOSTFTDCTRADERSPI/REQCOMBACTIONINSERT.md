...
<span class="anchor" id="2e6503e1-e3aa-42ad-a59c-7c93bc5fc117"></span>
## 1.函数原型
<p>virtual int ReqCombActionInsert(CThostFtdcInputCombActionField *pInputCombAction, int nRequestID) = 0;</p>
<span class="anchor" id="c49d9df5-d29f-4b5f-ab59-1e9fe794fda9"></span>
## 2.参数
...
<span class="anchor" id="53693c80-af03-4719-b848-6cd115d992e5"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="a37f3431-290a-479d-99a6-8e288b764f2a"></span>
## 4.调用示例
...
<span class="anchor" id="057b6247-7802-48b6-a60f-6238f9484617"></span>
## 5.FAQ
<p>无 </p>
