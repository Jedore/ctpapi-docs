...
<span class="anchor" id="2befbeaa-9e5b-4254-b0f9-d556b3f69f58"></span>
## 1.函数原型
<p>virtual int ReqQryAccountregister(CThostFtdcQryAccountregisterField *pQryAccountregister, int nRequestID) = 0;</p>
<span class="anchor" id="241dd485-ee6c-4f4f-8353-6b76f2b08b7f"></span>
## 2.参数
...
<span class="anchor" id="734316e2-64ee-4a1e-ab58-96de130da0a3"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="ed6a80eb-833d-42a8-9f19-a1b8d6cc467b"></span>
## 4.调用示例
...
<span class="anchor" id="a8209a13-6989-48a6-b23c-40a439e558cc"></span>
## 5.FAQ
