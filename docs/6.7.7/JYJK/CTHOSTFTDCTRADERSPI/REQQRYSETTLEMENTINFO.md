...
<span class="anchor" id="a1a23992-00d1-4c2a-8843-151fbdb7dc9a"></span>
## 1.函数原型
<p>virtual int ReqQrySettlementInfo(CThostFtdcQrySettlementInfoField *pQrySettlementInfo, int nRequestID) = 0;</p>
<span class="anchor" id="a5514453-dc8b-48b0-91e3-34ac049d9ab3"></span>
## 2.参数
...
<span class="anchor" id="85d5738e-b38e-4980-998a-3f926d8c93e0"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="6c9aebe2-e707-4b02-b777-a7a81f5e9f9d"></span>
## 4.调用示例
...
<span class="anchor" id="f388648c-2c25-4148-a4c5-a6be0a95591a"></span>
## 5.FAQ
