...
<span class="anchor" id="31b75109-09dd-4f60-95ee-edcbde2203ff"></span>
## 1.函数原型
<p>virtual int ReqQryQuote(CThostFtdcQryQuoteField *pQryQuote, int nRequestID) = 0;</p>
<span class="anchor" id="b1bdd19f-1209-439a-ba57-84cbaaa0c526"></span>
## 2.参数
<p>pQryQuote：报价查询</p>
...
<span class="anchor" id="080e3e4b-0cd5-4ed3-86b2-ef158dc7bf39"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="88f64330-4932-4bed-9830-6456cdd90d2b"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="a8ada7da-7fe7-44d0-8a7d-8bb43a6263fe"></span>
## 5.FAQ
<p>无</p>
