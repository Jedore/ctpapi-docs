...
<span class="anchor" id="44d540fc-68b3-4994-b58d-4edf4d19f122"></span>
## 1.函数原型
<p>virtual int ReqQryOrder(CThostFtdcQryOrderField *pQryOrder, int nRequestID) = 0;</p>
<span class="anchor" id="be5e8e81-39c6-459a-ac07-e863e1b08fdd"></span>
## 2.参数
<p>pQryOrder：查询报单</p>
...
<span class="anchor" id="2708e04b-2a37-4b4b-a44e-ee42266f9db1"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="46de8dbf-d2a1-49a5-aeec-2fe9b29f5815"></span>
## 4.调用示例
...
<span class="anchor" id="d3fb23e7-8188-4a31-9e2b-5fa1a6ee5034"></span>
## 5.FAQ
<p>无</p>
