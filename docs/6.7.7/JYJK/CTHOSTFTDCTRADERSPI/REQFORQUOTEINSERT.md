...
<span class="anchor" id="dbd97ddc-44b7-4e46-a6b0-7291f2883784"></span>
## 1.函数原型
<p>virtual int ReqForQuoteInsert(CThostFtdcInputForQuoteField *pInputForQuote, int nRequestID) = 0;</p>
<span class="anchor" id="5c19d970-7a02-4811-b4f4-0cea7ce5d671"></span>
## 2.参数
...
<span class="anchor" id="db0df877-f807-4e19-9b03-939070bac884"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="07f4c168-5b2c-4ba1-80c4-ff45d1b51956"></span>
## 4.调用示例
...
<span class="anchor" id="af3d3911-3225-42cb-9bf3-81344d3a184e"></span>
## 5.FAQ
