...
<span class="anchor" id="bdca0640-bc0c-48a9-a701-29fc55617340"></span>
## 1.函数原型
<p>virtual int ReqUserLogin(CThostFtdcReqUserLoginField *pReqUserLoginField, int nRequestID) = 0;</p>
<span class="anchor" id="e2ebd025-b0a9-4127-8c04-dffcb954068c"></span>
## 2.参数
...
<span class="anchor" id="cc2343de-f569-42c5-9fa0-f8fc410acc0c"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="706c7648-ac0f-457c-8bc7-2abccb4e0713"></span>
## 4.调用示例
...
<span class="anchor" id="369ef8fa-2342-4747-8a9a-1faa0c618c3a"></span>
## 5.FAQ
