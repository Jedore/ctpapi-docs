...
<span class="anchor" id="f52c0dd5-78db-4435-91d0-7576822fde3f"></span>
## 1.函数原型
<p>virtual int ReqQryProduct(CThostFtdcQryProductField *pQryProduct, int nRequestID) = 0;</p>
<span class="anchor" id="3c7e0265-4e4f-4096-8dec-59a04ce5dcd3"></span>
## 2.参数
...
<span class="anchor" id="ac5c433a-7cb0-4a66-9507-d25ca51028b7"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="bf9cd3fc-8d63-4df7-a382-e59599d2b647"></span>
## 4.调用示例
...
<span class="anchor" id="bcbe2640-ef3f-48c2-9555-48216f931756"></span>
## 5.FAQ
<p>无</p>
