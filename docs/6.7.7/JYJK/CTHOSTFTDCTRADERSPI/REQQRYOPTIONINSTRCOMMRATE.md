...
<span class="anchor" id="2e0571d9-d0a9-4f2e-b181-fb8584b97c82"></span>
## 1.函数原型
<p>virtual int ReqQryOptionInstrCommRate(CThostFtdcQryOptionInstrCommRateField *pQryOptionInstrCommRate, int nRequestID) = 0;</p>
<span class="anchor" id="b2489404-3276-4bc6-9805-23d1c190b8e6"></span>
## 2.参数
...
<span class="anchor" id="d1294dff-75ef-42b3-8760-87028d540078"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="55b7002e-528d-45a9-a3ae-e4ee4f19dec2"></span>
## 4.调用示例
...
<span class="anchor" id="ac593afe-caf9-4cab-a942-0e02d4e0bc6f"></span>
## 5.FAQ
