...
<span class="anchor" id="523c0db9-4c40-4db2-bfa4-bccd20a02e73"></span>
## 1.函数原型
<p>virtual int ReqExecOrderInsert(CThostFtdcInputExecOrderField *pInputExecOrder, int nRequestID) = 0;</p>
<span class="anchor" id="9085de36-e55f-42f1-950c-c277bb3b91c8"></span>
## 2.参数
...
<span class="anchor" id="e875c1cd-3151-402b-84c9-1eafab73b233"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="e7b5a76f-389f-491d-9eff-1824a4e5dc00"></span>
## 4.调用示例
...
<span class="anchor" id="8728c989-47bf-448f-a3d4-279ce8357785"></span>
## 5.FAQ
