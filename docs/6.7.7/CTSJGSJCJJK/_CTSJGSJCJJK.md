...
<span class="anchor" id="14257f96-fcc9-4d32-a072-421986d96f3a"></span>
## 1.定义
<table>
<tr>
...
<span class="anchor" id="8fe42034-ccf0-4832-a43f-44ef82f557f4"></span>
## 2.说明
...
<span class="anchor" id="9b9f77a5-8729-4420-98cd-863272674dfd"></span>
## 3.权限要求
<p>采集库需要u+s权限</p>
<span class="anchor" id="9c8589aa-e5fc-4e1c-91b6-4f69b5f29752"></span>
## 4.相关接口
<pre><code>///客户端认证请求
...
<span class="anchor" id="6d258e53-b864-42f8-a221-ca811da24709"></span>
## 5.示例代码
<p><strong>每个类型的终端调用流程不同，请注意区分！</strong></p>
<span class="anchor" id="f0c0f333-2ff2-44b7-a724-9b62d9b7525f"></span>
### 5.1.直连终端的采集使用流程示例代码：
...
<span class="anchor" id="cdbb7ba3-2534-43a3-90c9-50f7bf8b897f"></span>
### 5.2.多对多中继终端使用流程示例代码：
...
<span class="anchor" id="b4209897-e3b8-46a8-bf6b-de330f99e9c7"></span>
### 5.3.一对多中继终端使用流程示例代码：
