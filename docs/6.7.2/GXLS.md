...
<li><p>新增tas介绍</p></li>
<li><p>新增fens介绍</p></li>
<li><p>更正代码示例错误，<a href="../JYJK/CTHOSTFTDCTRADERSPI/RELEASE/">Release</a>()前使用<a href="../JYJK/CTHOSTFTDCTRADERSPI/REGISTERSPI/">RegisterSpi</a>(NULL)，这个代码是错误的，会导致api概率崩溃。</p></li>
