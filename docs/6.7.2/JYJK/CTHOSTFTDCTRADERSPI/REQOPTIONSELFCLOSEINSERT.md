...
<span class="anchor" id="7061c63f-3cca-460e-a8b5-4120d32732d5"></span>
## 1.函数原型
<p>virtual int ReqOptionSelfCloseInsert(CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose, int nRequestID) = 0;</p>
<span class="anchor" id="16155301-c12b-41db-a942-449b9b6a6141"></span>
## 2.参数
...
<span class="anchor" id="69357ce2-51f1-4cd8-ac58-8dadd15195ee"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="0c0d065d-006f-410c-b00c-3c335cce6a20"></span>
## 4.调用示例
...
<span class="anchor" id="21d94a36-dd27-4928-a144-b84d4d92109d"></span>
## 5.FAQ
