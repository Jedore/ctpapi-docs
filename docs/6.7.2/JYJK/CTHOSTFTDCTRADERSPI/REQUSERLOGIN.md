<p>用户登录请求，对应响应<a href="../../CTHOSTFTDCTRADERAPI/ONRSPUSERLOGIN/">OnRspUserLogin</a>。</p>
<p>接口包含采集函数不是线程安全的，不同线程同步调用建议加锁。</p>
<span class="anchor" id="4dbadf62-8519-4601-8eeb-2bee8c507294"></span>
## 1.函数原型
<p>virtual int ReqUserLogin(CThostFtdcReqUserLoginField *pReqUserLoginField, int nRequestID) = 0;</p>
<span class="anchor" id="37090d75-d8c8-46de-b0ca-080bddf7e21c"></span>
## 2.参数
...
<span class="anchor" id="b24b45bf-b815-4db2-b690-0e029cc874dc"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="cd288b38-439c-4abe-81f6-dda6be93936e"></span>
## 4.调用示例
...
<span class="anchor" id="17a2609b-b1ab-4a52-8394-3bac64cde651"></span>
## 5.FAQ
