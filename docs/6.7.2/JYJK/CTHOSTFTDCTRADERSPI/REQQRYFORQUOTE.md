...
<span class="anchor" id="be904dae-dcf2-44ad-9b0c-7d0dc72c0eec"></span>
## 1.函数原型
<p>virtual int ReqQryForQuote(CThostFtdcQryForQuoteField *pQryForQuote, int nRequestID) = 0;</p>
<span class="anchor" id="55cb1406-ef0e-456c-a4a2-14d4f762e183"></span>
## 2.参数
...
<span class="anchor" id="81608315-549d-4b3c-91fe-6305b4d1afab"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="91b775ec-811f-4be5-90c0-32a2414ed6a4"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="6c99e96d-5e91-4082-9632-8e5606b90eee"></span>
## 5.FAQ
<p>无</p>
