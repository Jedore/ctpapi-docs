...
<span class="anchor" id="d6c7a550-f750-4dd0-9a5d-7b0bc952c268"></span>
## 1.函数原型
<p>virtual int ReqQryTrade(CThostFtdcQryTradeField *pQryTrade, int nRequestID) = 0;</p>
<span class="anchor" id="2ab24b37-88e3-40ae-a312-8f8edd80bcab"></span>
## 2.参数
<p>pQryTrade：查询成交</p>
...
<span class="anchor" id="9dfdf8fb-d357-40fe-bd38-8adaed0d4a77"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="4700010c-2a1d-47f7-801d-0ea54ebe2d63"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="13d93bdf-9bba-4d1a-a7bc-507615fda1ed"></span>
## 5.FAQ
<p>无</p>
