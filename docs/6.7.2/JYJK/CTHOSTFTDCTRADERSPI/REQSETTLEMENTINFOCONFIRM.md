...
<span class="anchor" id="cd60c3b6-7a70-44b4-a359-2ff3ec800a24"></span>
## 1.函数原型
<p>virtual int ReqSettlementInfoConfirm(CThostFtdcSettlementInfoConfirmField *pSettlementInfoConfirm, int nRequestID) = 0;</p>
<span class="anchor" id="feaeaa69-0ec5-4b0a-8eb5-c68c5eb00c55"></span>
## 2.参数
...
<span class="anchor" id="7fcf6465-62d8-4b07-9f07-cdeb271f8ed0"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="004d89b5-4678-4df0-857a-f0e73e14fd05"></span>
## 4.调用示例
...
<span class="anchor" id="d46b8eaf-b1b9-4170-a8a7-492d2f0de980"></span>
## 5.FAQ
<p>无</p>
