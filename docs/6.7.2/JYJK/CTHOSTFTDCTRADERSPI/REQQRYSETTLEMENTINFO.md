...
<span class="anchor" id="f68242b2-90f6-4698-8432-d2761c0057ea"></span>
## 1.函数原型
<p>virtual int ReqQrySettlementInfo(CThostFtdcQrySettlementInfoField *pQrySettlementInfo, int nRequestID) = 0;</p>
<span class="anchor" id="60357395-6871-4feb-b7a9-1926cf39d366"></span>
## 2.参数
...
<span class="anchor" id="4c4040e6-7fdf-462a-80ab-1a02e8866ca9"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="ef7eddc8-6bc9-4538-bef6-4606636442f9"></span>
## 4.调用示例
...
<span class="anchor" id="349c58cd-f602-4ee5-a25c-44928d68c4e9"></span>
## 5.FAQ
