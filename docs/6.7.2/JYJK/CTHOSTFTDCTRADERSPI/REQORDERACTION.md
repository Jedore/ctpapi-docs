...
<span class="anchor" id="66efa1c9-3452-439a-8163-c556e6931ff5"></span>
## 1.函数原型
<p>virtual int ReqOrderAction(CThostFtdcInputOrderActionField *pInputOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="20cfc02b-a518-498a-a933-49badf8d39eb"></span>
## 2.参数
...
<span class="anchor" id="781094fb-1413-4e64-8198-84b43113d4d8"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="d68b8d59-b809-4ea6-ab4e-553453ce11b7"></span>
## 4.调用示例
...
<span class="anchor" id="20de07b4-31e5-45ac-92ea-3b189ce2817c"></span>
## 5.FAQ
