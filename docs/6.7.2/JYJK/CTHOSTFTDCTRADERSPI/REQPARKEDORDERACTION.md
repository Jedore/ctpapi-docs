...
<span class="anchor" id="9c2fb59e-a295-491a-8262-023bf761f429"></span>
## 1.函数原型
<p>virtual int ReqParkedOrderAction(CThostFtdcParkedOrderActionField *pParkedOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="9e0f90ba-4f3b-4fe0-89d9-21c8ee6098a6"></span>
## 2.参数
...
<span class="anchor" id="4699c2c3-3720-4387-a529-5a90db779e64"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="05030196-17a7-49e2-8e0a-782decb72f15"></span>
## 4.调用示例
...
<span class="anchor" id="111aaf59-f678-423e-ba0e-0e77edfea9fb"></span>
## 5.FAQ
<p>无</p>
