...
<span class="anchor" id="ee73c02c-5552-42c1-a796-1e42987700a4"></span>
## 1.函数原型
<p>virtual int ReqBatchOrderAction(CThostFtdcInputBatchOrderActionField *pInputBatchOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="3d0635cf-5eb7-4ddf-a186-37c36687aba8"></span>
## 2.参数
...
<span class="anchor" id="172c510c-f203-47d6-9132-02eeab2fad33"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="6a41be7c-148a-4fea-9fa5-1369cc8b8d54"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="0cb32927-b688-4728-81c4-b2d6cb4b0d82"></span>
## 5.FAQ
<p>无</p>
