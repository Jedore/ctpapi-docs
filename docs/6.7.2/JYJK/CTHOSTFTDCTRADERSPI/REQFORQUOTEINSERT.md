...
<span class="anchor" id="2e9b530d-f180-4347-8927-752bfe849012"></span>
## 1.函数原型
<p>virtual int ReqForQuoteInsert(CThostFtdcInputForQuoteField *pInputForQuote, int nRequestID) = 0;</p>
<span class="anchor" id="09277187-be0c-4ccf-9374-70c5aada44c0"></span>
## 2.参数
...
<span class="anchor" id="fd8dceec-d98e-4472-96d9-dfd3a9e49a4b"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="090b2039-0f4c-46ef-9bb0-469c9fb1009d"></span>
## 4.调用示例
...
<span class="anchor" id="7785f88d-b785-4537-80d5-8f39d9acce84"></span>
## 5.FAQ
