...
<span class="anchor" id="88c8157e-ee37-46f6-b5e8-08590bb9c031"></span>
## 1.函数原型
<p>virtual int ReqQryQuote(CThostFtdcQryQuoteField *pQryQuote, int nRequestID) = 0;</p>
<span class="anchor" id="dfb0de19-6da6-460a-945e-004c02cfbf6e"></span>
## 2.参数
<p>pQryQuote：报价查询</p>
...
<span class="anchor" id="a553fb0b-9cb9-4534-bd9d-2672416f0d51"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="9b4e4624-4c92-4f56-8e8d-4a4b7c1bf6ea"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="04102f27-f289-4f09-8450-9460c8ec7675"></span>
## 5.FAQ
<p>无</p>
