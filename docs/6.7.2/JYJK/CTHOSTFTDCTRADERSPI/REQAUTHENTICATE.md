...
<span class="anchor" id="6289fa9d-602e-4b29-acc9-66d5e9de8ba0"></span>
## 1.函数原型
<p>virtual int ReqAuthenticate(CThostFtdcReqAuthenticateField *pReqAuthenticateField, int nRequestID) = 0;</p>
<span class="anchor" id="112b6f3e-d94e-4bc1-b05a-573b485ecfae"></span>
## 2.参数
...
<span class="anchor" id="441da0cf-a584-481e-9b79-8a5f69455e0b"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="4c6888b1-a133-42ab-9185-f4ec2961849f"></span>
## 4.调用示例
...
<span class="anchor" id="963ad975-f98a-4a36-8974-d3d100e5fe6a"></span>
## 5.FAQ
