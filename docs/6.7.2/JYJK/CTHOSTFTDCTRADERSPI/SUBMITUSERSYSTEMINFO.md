...
<span class="anchor" id="7a64716b-a0bc-4bcf-9a85-4fe67a330606"></span>
## 1.函数原型
<p>virtual int SubmitUserSystemInfo(CThostFtdcUserSystemInfoField *pUserSystemInfo) = 0;</p>
<span class="anchor" id="40ec457b-03fb-42f2-9a76-678f48f10c1f"></span>
## 2.参数
...
<span class="anchor" id="2567299d-9dce-4821-98ef-0331bf060539"></span>
## 3.返回
<p>0 正确</p>
<p>-1 字段长度不对</p>
<p>-2 非CTP采集的终端信息</p>
...
<p>-6 采集结果字段错误</p>
<span class="anchor" id="10a62e35-0733-4025-bf70-44f98078e012"></span>
## 4.调用示例
<p>//一对多中继终端使用方法   </p>
...
<span class="anchor" id="672171d6-1454-44c9-8e9e-75724e5f1cd8"></span>
## 5.FAQ
