...
<span class="anchor" id="2517e2ca-1138-41c6-a9b4-907cf8650ccf"></span>
## 1.函数原型
<p>virtual int ReqRemoveParkedOrder(CThostFtdcRemoveParkedOrderField *pRemoveParkedOrder, int nRequestID) = 0;</p>
<span class="anchor" id="7f324fdc-5718-4a1a-bfd9-ed62c36c9006"></span>
## 2.参数
...
<span class="anchor" id="336b6d8c-41c6-4d2e-8d69-402cecdd2b14"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="5a9a289d-72db-449a-b9ea-76549df704b5"></span>
## 4.示例调用
...
<span class="anchor" id="eb7aa131-8496-4fbd-8dd6-b1d1942bfa3e"></span>
## 5.FAQ
<p>无</p>
