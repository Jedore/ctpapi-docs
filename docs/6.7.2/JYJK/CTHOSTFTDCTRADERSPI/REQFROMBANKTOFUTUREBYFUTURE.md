...
<span class="anchor" id="7c66455e-6d9b-49b3-9d71-d527ba6efb5e"></span>
## 1.函数原型
<p>virtual int ReqFromBankToFutureByFuture(CThostFtdcReqTransferField *pReqTransfer, int nRequestID) = 0;</p>
<span class="anchor" id="d9cb9ff9-54f2-42d5-bb48-e32e2d9ffe43"></span>
## 2.参数
...
<span class="anchor" id="a1b427c0-f73e-4d83-b701-239373daa631"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="92cb956d-ee44-4bba-9dcf-dea214bf469a"></span>
## 4.调用示例
...
<span class="anchor" id="9ab6e9d6-448b-4dfe-814d-81556845e23f"></span>
## 5.FAQ
<p>无</p>
