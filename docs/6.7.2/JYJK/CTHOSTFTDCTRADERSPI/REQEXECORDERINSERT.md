...
<span class="anchor" id="f3b70008-a04f-4697-b962-a993bec9448c"></span>
## 1.函数原型
<p>virtual int ReqExecOrderInsert(CThostFtdcInputExecOrderField *pInputExecOrder, int nRequestID) = 0;</p>
<span class="anchor" id="241440cb-a7a0-4b5a-bfa0-e37dedcd6162"></span>
## 2.参数
...
<span class="anchor" id="83fc68b5-9f5c-429a-8330-986b02b38c84"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="68e9e8b3-ac8c-46f1-a1ff-db4692b227dc"></span>
## 4.调用示例
...
<span class="anchor" id="6bdd4e4c-e788-42fe-8ba9-eb072a12b854"></span>
## 5.FAQ
