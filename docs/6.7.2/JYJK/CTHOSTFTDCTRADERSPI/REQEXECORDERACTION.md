...
<span class="anchor" id="708022e1-6eaa-44be-8872-ef3220dea7dd"></span>
## 1.函数原型
<p>virtual int ReqExecOrderAction(CThostFtdcInputExecOrderActionField *pInputExecOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="85af6664-1d27-4901-bc1b-ecd2e8c0bad2"></span>
## 2.参数
...
<span class="anchor" id="f6ae532a-c597-4a6d-9475-6633b7457230"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="198a5e89-4356-4366-b1f9-9088b071a01b"></span>
## 4.调用示例
...
<span class="anchor" id="d3e27364-e9f5-47ea-9816-8388b969a951"></span>
## 5.FAQ
<p>无</p>
