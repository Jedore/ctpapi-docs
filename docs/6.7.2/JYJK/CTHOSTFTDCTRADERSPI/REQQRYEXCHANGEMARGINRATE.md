...
<span class="anchor" id="9fc5cfa3-9337-4b8f-8c94-406b25cdf896"></span>
## 1.函数原型
<p>virtual int ReqQryExchangeMarginRate(CThostFtdcQryExchangeMarginRateField *pQryExchangeMarginRate, int nRequestID) = 0;</p>
<span class="anchor" id="a08ddb76-4476-44bb-a6bb-ff1454c343f0"></span>
## 2.参数
...
<span class="anchor" id="c9e7829e-f742-43f2-b017-f3b14a42b18a"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="37c1b040-bd52-49d6-b89b-82de79d75413"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="d8533d94-8ca9-4b62-833c-96102e6277c5"></span>
## 5.FAQ
<p>无</p>
