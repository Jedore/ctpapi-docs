...
<span class="anchor" id="e11ca817-be85-4e16-bc98-15a93d04dafd"></span>
## 1.函数原型
<p>virtual int ReqQrySecAgentTradingAccount(CThostFtdcQryTradingAccountField *pQryTradingAccount, int nRequestID) = 0;</p>
<span class="anchor" id="2b443b47-ebf7-49a6-99d2-d2c28b3fdda5"></span>
## 2.参数
...
<span class="anchor" id="5eac757a-d560-4f8e-8e29-cf945fa973c5"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="7fa7b59d-0c9f-4a56-b071-5d27246a161f"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="bf39950b-e7af-4653-b10c-b9a40953408c"></span>
## 5.FAQ
<p>无</p>
