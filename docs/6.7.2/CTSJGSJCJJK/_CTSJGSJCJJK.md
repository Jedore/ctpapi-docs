...
<span class="anchor" id="f98b4bfb-ef4f-4fec-931a-8b3734fdc8e9"></span>
## 1.定义
<table>
<tr>
...
<span class="anchor" id="10a8487a-a7a4-46bd-b83e-846b7168661a"></span>
## 2.说明
...
<span class="anchor" id="1a096851-e5fc-4f85-8279-1936791794be"></span>
## 3.权限要求
<p>采集库需要u+s权限</p>
<span class="anchor" id="5a532b54-8628-4e91-bd6c-f8e419100cb1"></span>
## 4.相关接口
<pre><code>///客户端认证请求
...
<span class="anchor" id="79ceba9c-9476-4c2c-af34-310918dcb5b4"></span>
## 5.示例代码
<p><strong>每个类型的终端调用流程不同，请注意区分！</strong></p>
<span class="anchor" id="8eca191e-a008-4a04-b309-500f5e25575a"></span>
### 5.1.直连终端的采集使用流程示例代码：
...
<span class="anchor" id="33db0896-f1ae-45f6-ae06-602d6a855f47"></span>
### 5.2.多对多中继终端使用流程示例代码：
...
<span class="anchor" id="d83f3db5-133a-4a97-b214-4b630fba7f23"></span>
### 5.3.一对多中继终端使用流程示例代码：
