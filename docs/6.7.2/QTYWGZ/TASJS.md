...
<span class="anchor" id="f00f24ff-09b3-45b5-9601-72424e636139"></span>
## 1.交易时间
<p>交易日9：00-10：15、10：30-11：30</p>
<span class="anchor" id="035be99c-2752-44d6-9660-25eafb8cc2ea"></span>
## 2. 报单
...
<span class="anchor" id="68eec0ae-bee5-4beb-9ab3-9ebc940607c1"></span>
## 3. 成交
...
<span class="anchor" id="a063a75d-7686-477e-9926-067046d74c88"></span>
## 4. 持仓
...
<span class="anchor" id="9024f365-c0ec-4679-b296-b1d039f04500"></span>
## 5. 手续费和保证金
<p>开仓保证金和手续费冻结都按照标的合约停板价冻结。</p>
<p>实收保证金率和手续费率都按照标的合约计算。</p>
<p>保证金率和手续费率使用标的合约的费率，通过费率查询接口只能查询到标的合约的费率。</p>
<span class="anchor" id="fa26f3c7-913c-42b6-a766-803c4fdac896"></span>
## 6. 盈亏
<p>计算持仓盈亏的时候，对于(总数量-TAS数量)部分计算持仓盈亏和保证金。对于TAS数量不计算盈亏。</p>
<span class="anchor" id="55e67cb6-5b98-4bcf-a902-c8f1b86ad183"></span>
## 7.合约行情
<p>合约代码、合约状态、买卖方向、报单量、成交量、日期、时间等字段正常发布。其余字段无意义，均为空。</p>
<p>盘中TAS成交量、成交额不计入标的合约的成交量、成交额。</p>
<span class="anchor" id="1aeabd19-b5d2-47f4-b32d-8a4aec48dfa8"></span>
## 8.升贴水
<p>能源交易所TAS的委托价格可以浮动正负N个最小变动价位，N即为tas的升贴水，N范围为tas的涨跌停板价之间</p>
<span class="anchor" id="16c073a3-2f0b-4870-9bb7-a8a966f1fe25"></span>
## 9.代码示例
