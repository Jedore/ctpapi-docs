...
<span class="anchor" id="e2a3024f-21e8-4517-a42f-8717ffb3746f"></span>
## 1.函数原型
<p>virtual int ReqQryExecOrder(CThostFtdcQryExecOrderField *pQryExecOrder, int nRequestID) = 0;</p>
<span class="anchor" id="a859fa26-68a7-4049-8743-46fd5ad06e83"></span>
## 2.参数
...
<span class="anchor" id="8088111e-3583-4f43-93d4-7ace840877c7"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="74ea7b29-28b5-43b7-b637-9b772de3573e"></span>
## 4.调用示例
...
<span class="anchor" id="b64a002b-c2a0-490f-a177-ff41e4b4a99d"></span>
## 5.FAQ
<p>无</p>
