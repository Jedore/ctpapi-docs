...
<span class="anchor" id="93bda956-d065-4190-83ec-6600ac0c83c9"></span>
## 1.函数原型
<p>virtual int ReqQuoteInsert(CThostFtdcInputQuoteField *pInputQuote, int nRequestID) = 0;</p>
<span class="anchor" id="b7642582-e921-44b6-a31d-687c085a5bac"></span>
## 2.参数
...
<span class="anchor" id="597cd62b-45e5-4dca-8e97-2426bb15a7e0"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="cec93781-2c72-4ed1-874b-e0ddbaf8853d"></span>
## 4.示例调用
...
<span class="anchor" id="4534ccbf-7807-4033-aa81-7c8badc778cc"></span>
## 5.FAQ
