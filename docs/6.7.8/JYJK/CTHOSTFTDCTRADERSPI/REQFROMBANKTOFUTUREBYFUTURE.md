...
<span class="anchor" id="b37017c9-31cc-4456-b6ab-7d465c90fdd8"></span>
## 1.函数原型
<p>virtual int ReqFromBankToFutureByFuture(CThostFtdcReqTransferField *pReqTransfer, int nRequestID) = 0;</p>
<span class="anchor" id="0101da1d-6347-4b64-92a3-0a0fa7602aa7"></span>
## 2.参数
...
<span class="anchor" id="35bd7318-7ff9-4c2d-bcf6-649d30f0a40c"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="d79c0e50-5d7d-4b5a-8acf-1a4c70d83205"></span>
## 4.调用示例
...
<span class="anchor" id="50b80431-abd5-4e2a-a4b8-e5e16ee26d80"></span>
## 5.FAQ
<p>无</p>
