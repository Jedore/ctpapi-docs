...
<span class="anchor" id="921a947f-adb3-4244-b73f-7ad68c9a3a4c"></span>
## 1.函数原型
<p>virtual int ReqQryTrade(CThostFtdcQryTradeField *pQryTrade, int nRequestID) = 0;</p>
<span class="anchor" id="4c1a2396-df8c-4e66-bec6-b70308f76059"></span>
## 2.参数
<p>pQryTrade：查询成交</p>
...
<span class="anchor" id="5f6f6dd7-4a43-4a15-b6b3-888035f0e575"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="3f894c27-16bd-4903-a8d8-b96dffccf298"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="66ec308d-8311-485d-a7a7-5ed55c973a76"></span>
## 5.FAQ
<p>无</p>
