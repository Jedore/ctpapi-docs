<p>期权自对冲操作请求、详见<a href="../../../QTYWGZ/QHQQDHQ-ZDCGZ/">期货期权的行权、自对冲</a></p>
...
<span class="anchor" id="ba845d12-3449-4814-a565-5e14939d9a43"></span>
## 1.函数原型
...
<span class="anchor" id="f598d272-84de-4b36-a8b2-73ccaac80f9b"></span>
## 2.参数
...
<span class="anchor" id="5943cc8f-1b2c-417d-a3d7-ff28f20c67ff"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="c9cbb52e-1e59-463e-a5ce-8f25314d6905"></span>
## 4.调用示例
...
<span class="anchor" id="efd6b681-6afb-40f5-8728-b5bea433f809"></span>
## 5.FAQ
<p>无</p>
