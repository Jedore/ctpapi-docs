...
<span class="anchor" id="c0c7352a-3071-440e-88ad-cacb5763c5d4"></span>
## 1.函数原型
<p>virtual int ReqCombActionInsert(CThostFtdcInputCombActionField *pInputCombAction, int nRequestID) = 0;</p>
<span class="anchor" id="7e2d948d-189a-445c-b564-bdc66fad3038"></span>
## 2.参数
...
<span class="anchor" id="b88f4c1f-b0a8-47e5-aea1-6ae3f354c297"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="820f37a2-6fc3-4b52-9269-6ebaff1461da"></span>
## 4.调用示例
...
<span class="anchor" id="1469c9c2-42c5-455a-aed7-219a3f6d380f"></span>
## 5.FAQ
<p>无 </p>
