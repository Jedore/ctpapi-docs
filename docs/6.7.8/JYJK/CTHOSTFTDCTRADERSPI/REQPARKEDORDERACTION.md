...
<span class="anchor" id="2d29117b-4d44-45bb-8908-24592aab1d47"></span>
## 1.函数原型
<p>virtual int ReqParkedOrderAction(CThostFtdcParkedOrderActionField *pParkedOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="08376cea-fd93-47bb-8eab-724d7c2c90ba"></span>
## 2.参数
...
<span class="anchor" id="662e5e86-0064-483f-a2ee-434c3982dfa7"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="9597ce0a-959b-473e-a100-c20bc818dbbc"></span>
## 4.调用示例
...
<span class="anchor" id="a8e86bb0-d2e7-4378-b1a5-d108b6fd36e8"></span>
## 5.FAQ
<p>无</p>
