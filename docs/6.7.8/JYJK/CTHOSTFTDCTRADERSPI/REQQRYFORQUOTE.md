...
<span class="anchor" id="6d6a923a-7b60-4947-92d7-1ffead725614"></span>
## 1.函数原型
<p>virtual int ReqQryForQuote(CThostFtdcQryForQuoteField *pQryForQuote, int nRequestID) = 0;</p>
<span class="anchor" id="3775fea7-395d-47ad-9349-62e3ede82b73"></span>
## 2.参数
...
<span class="anchor" id="d07630ac-cc29-42ef-8ad2-e9ed02517535"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="1a5b86bd-da92-4ed0-8b5f-9b4a8d2b7345"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="f3c3e4bb-9cd4-4cc0-9a23-0c7a6092fa60"></span>
## 5.FAQ
<p>无</p>
