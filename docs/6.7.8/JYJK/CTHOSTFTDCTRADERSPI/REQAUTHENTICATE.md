...
<span class="anchor" id="f5707291-e6ed-4c6d-b7f1-8c61500fe174"></span>
## 1.函数原型
<p>virtual int ReqAuthenticate(CThostFtdcReqAuthenticateField *pReqAuthenticateField, int nRequestID) = 0;</p>
<span class="anchor" id="607503e2-94a0-4784-8b02-95331f665e40"></span>
## 2.参数
...
<span class="anchor" id="7e152519-07e7-437b-a405-6d2e91c49fe5"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="e506195e-3f63-4cce-a32f-b1e1796228bd"></span>
## 4.调用示例
...
<span class="anchor" id="352b014a-e52f-4d2c-9721-0b23bea2380c"></span>
## 5.FAQ
