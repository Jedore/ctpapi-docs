<p>用户登录请求，对应响应<a href="../../../HQJK/CTHOSTFTDCMDSPI/ONRSPUSERLOGIN/">OnRspUserLogin</a>。</p>
<p>接口包含采集函数不是线程安全的，不同线程同步调用建议加锁。</p>
<span class="anchor" id="056a2c26-1d2a-4619-80ef-b4f800faf327"></span>
## 1.函数原型
<p>virtual int ReqUserLogin(CThostFtdcReqUserLoginField *pReqUserLoginField, int nRequestID) = 0;</p>
<span class="anchor" id="e679030e-9089-4e0e-9918-201f0a0cb36f"></span>
## 2.参数
...
<span class="anchor" id="d503f415-15e6-4a7c-9459-1fc5a79e0853"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="c6802e74-0c38-4f9e-ba18-b5206d1e9a22"></span>
## 4.调用示例
...
<span class="anchor" id="77b2369f-8632-4a44-b704-e240c803844a"></span>
## 5.FAQ
