...
<span class="anchor" id="1120db8c-62ac-43da-a6d0-f3f706ef0343"></span>
## 1.函数原型
<p>virtual int ReqQryQuote(CThostFtdcQryQuoteField *pQryQuote, int nRequestID) = 0;</p>
<span class="anchor" id="930579da-ae61-4c55-8dec-2c840e6ce7fb"></span>
## 2.参数
<p>pQryQuote：报价查询</p>
...
<span class="anchor" id="96db5ccf-d4b3-44ad-9be1-51a47b0df79a"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="cd5ede7e-a39c-4820-b276-bc5234b81d4c"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="58cb8271-6050-487b-9053-46e01c6ae58a"></span>
## 5.FAQ
<p>无</p>
