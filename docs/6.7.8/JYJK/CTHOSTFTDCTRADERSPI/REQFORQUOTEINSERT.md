...
<span class="anchor" id="64fa8771-9c72-4b62-82ff-dd1f8157b4e7"></span>
## 1.函数原型
<p>virtual int ReqForQuoteInsert(CThostFtdcInputForQuoteField *pInputForQuote, int nRequestID) = 0;</p>
<span class="anchor" id="1b8c0aac-908e-4491-abdf-b05d2f8b843a"></span>
## 2.参数
...
<span class="anchor" id="ad1b44fb-dd02-4a81-b205-ba9c698b116b"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="048b4c81-fc45-49bd-af55-d3151b0e1473"></span>
## 4.调用示例
...
<span class="anchor" id="8894e326-e6cb-4abb-a118-e0596421dee6"></span>
## 5.FAQ
