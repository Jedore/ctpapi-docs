<p>执行宣告操作请求、详见<a href="../../../QTYWGZ/QHQQDHQ-ZDCGZ/">期货期权的行权、自对冲</a></p>
...
<span class="anchor" id="7987362a-f9aa-4476-a3e1-a48de8604f33"></span>
## 1.函数原型
<p>virtual int ReqExecOrderAction(CThostFtdcInputExecOrderActionField *pInputExecOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="2557ca8d-54bb-4e41-9c83-07030c20bb5c"></span>
## 2.参数
...
<span class="anchor" id="750a9228-13d5-48ae-8a7f-980cb413a467"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="b700f3be-ea9a-4a68-bdab-ee7f1006a129"></span>
## 4.调用示例
...
<span class="anchor" id="71928674-7078-4ccf-ae7c-507091446225"></span>
## 5.FAQ
<p>无</p>
