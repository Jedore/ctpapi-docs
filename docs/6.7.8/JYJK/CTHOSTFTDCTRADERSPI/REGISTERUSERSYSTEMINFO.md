...
<span class="anchor" id="a0247235-6735-4599-80af-a81ed1dd88e4"></span>
## 1.函数原型
<p>virtual int RegisterUserSystemInfo(CThostFtdcUserSystemInfoField *pUserSystemInfo) = 0;</p>
<span class="anchor" id="6f1f7586-01f6-4778-8616-4b3793265a06"></span>
## 2.参数
...
<span class="anchor" id="4211ebcc-a6a3-4d7f-8a65-233f39143723"></span>
## 3.返回
<p>0 正确</p>
<p>-1 字段长度不对</p>
<p>-2 非CTP采集的终端信息</p>
...
<span class="anchor" id="06baa795-a397-46d1-881b-dfdcd51de65f"></span>
## 4.调用示例
<p>//多对多中继终端使用流程</p>
...
<span class="anchor" id="f7f2e01f-3abe-415c-98b5-2eaa4484e596"></span>
## 5.FAQ
