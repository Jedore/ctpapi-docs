...
<span class="anchor" id="4dcd8c7f-69b2-499e-8fb7-9ac1dce85a76"></span>
## 1.函数原型
<p>virtual int ReqFromFutureToBankByFuture(CThostFtdcReqTransferField *pReqTransfer, int nRequestID) = 0;</p>
<span class="anchor" id="756baf70-c486-4401-ac7b-3a22a88785df"></span>
## 2.参数
...
<span class="anchor" id="db437979-dfcb-4391-9442-2292f7e2efa0"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="5aea7cf2-74d7-4853-ade4-9435345ac34d"></span>
## 4.调用示例
...
<span class="anchor" id="4182a697-20b8-4e0d-9bea-10dd2d437925"></span>
## 5.FAQ
<p>无</p>
