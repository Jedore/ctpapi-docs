...
<span class="anchor" id="d4f2c78b-253b-414a-923d-0113b00746f2"></span>
## 1.定义
<table>
<tr>
...
<span class="anchor" id="f3db7d21-2567-4014-9e50-9e143dac3a52"></span>
## 2.说明
...
<span class="anchor" id="70159c86-90ff-4ecb-9665-608fcd7439e8"></span>
## 3.权限要求
<p>采集库需要u+s权限</p>
<span class="anchor" id="50cb668c-7b38-4f18-9848-0e632ba5721d"></span>
## 4.相关接口
<pre><code>///客户端认证请求
...
<span class="anchor" id="0c3fd0bc-2e92-4d86-a660-a8163b2ea343"></span>
## 5.示例代码
<p><strong>每个类型的终端调用流程不同，请注意区分！</strong></p>
<span class="anchor" id="e102df56-280b-435c-8427-64218005c9c4"></span>
### 5.1.直连终端的采集使用流程示例代码：
...
<span class="anchor" id="5241a191-43c6-4848-a3de-447b2cebbdc5"></span>
### 5.2.多对多中继终端使用流程示例代码：
...
<span class="anchor" id="cd1ef6e3-6b8d-489a-a496-f8486839077d"></span>
### 5.3.一对多中继终端使用流程示例代码：
