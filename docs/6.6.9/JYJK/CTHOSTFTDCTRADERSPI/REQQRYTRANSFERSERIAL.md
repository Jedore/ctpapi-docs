...
<span class="anchor" id="3b0cee4d-5087-4a3d-96eb-5c49f26dfda8"></span>
## 1.函数原型
<p>virtual int ReqQryTransferSerial(CThostFtdcQryTransferSerialField *pQryTransferSerial, int nRequestID) = 0;</p>
<span class="anchor" id="04d95537-3c0a-47b9-9b93-42265d25b914"></span>
## 2.参数
...
<span class="anchor" id="4a662c13-7640-4484-b4d9-349dfcde99d3"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="dc224da6-c81c-4d97-90a3-85c0e56bd720"></span>
## 4.调用示例
...
<span class="anchor" id="c328ea70-5d26-49cc-9384-34b27e1fa83e"></span>
## 5.FAQ
