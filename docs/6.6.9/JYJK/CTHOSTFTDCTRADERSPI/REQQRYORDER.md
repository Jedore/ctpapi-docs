...
<span class="anchor" id="d1cd115a-8799-4d2c-903c-7b96c6189ecb"></span>
## 1.函数原型
<p>virtual int ReqQryOrder(CThostFtdcQryOrderField *pQryOrder, int nRequestID) = 0;</p>
<span class="anchor" id="42b7b374-96bb-4703-a843-b5de99d660bf"></span>
## 2.参数
<p>pQryOrder：查询报单</p>
...
<span class="anchor" id="c5604c53-e286-42fe-b411-c269db1c387d"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="718ff70e-8ad3-4a54-bcab-1265353197c9"></span>
## 4.调用示例
...
<span class="anchor" id="4fe23eb5-52cb-4f3d-aa0b-84fbb58c8a59"></span>
## 5.FAQ
<p>无</p>
