...
<span class="anchor" id="814e8aa7-f95a-461a-8f7e-535dae1ada5f"></span>
## 1.函数原型
<p>virtual int ReqQryExecOrder(CThostFtdcQryExecOrderField *pQryExecOrder, int nRequestID) = 0;</p>
<span class="anchor" id="7c04f6d3-85cf-46d0-9132-d9d16c820e05"></span>
## 2.参数
...
<span class="anchor" id="b214d8fb-cb1c-4e14-8a9b-177de1ac5066"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="ec710de6-0d3b-4eb9-ae6c-93e28f806eee"></span>
## 4.调用示例
...
<span class="anchor" id="9682d06e-ebf6-41cb-82c9-45946689e3cb"></span>
## 5.FAQ
<p>无</p>
