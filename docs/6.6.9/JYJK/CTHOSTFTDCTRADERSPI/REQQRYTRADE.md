...
<span class="anchor" id="9040e96b-6073-4c50-8158-a200547b751f"></span>
## 1.函数原型
<p>virtual int ReqQryTrade(CThostFtdcQryTradeField *pQryTrade, int nRequestID) = 0;</p>
<span class="anchor" id="95e404c0-89c8-43e8-985b-9e5b17eb08cf"></span>
## 2.参数
<p>pQryTrade：查询成交</p>
...
<span class="anchor" id="e5061393-d332-4108-b3a5-e9927a486d9a"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="037ab04d-190a-479c-9b71-fae0f9a2df01"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="c3441b79-622d-41a0-9d67-2436f5dccc95"></span>
## 5.FAQ
<p>无</p>
