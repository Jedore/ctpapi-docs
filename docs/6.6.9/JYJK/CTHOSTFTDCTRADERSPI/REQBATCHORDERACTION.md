...
<span class="anchor" id="d41c974a-96a4-486a-8f16-5d00c3543fe7"></span>
## 1.函数原型
<p>virtual int ReqBatchOrderAction(CThostFtdcInputBatchOrderActionField *pInputBatchOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="c91c0137-6f30-428c-859d-13941bf71153"></span>
## 2.参数
...
<span class="anchor" id="3d360c06-6e8a-4da9-bf88-c212f8793e58"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="1b481094-5485-410f-8630-eea895cb13fb"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="63282f7e-d0a6-4336-a864-6a7129cc9bc6"></span>
## 5.FAQ
<p>无</p>
