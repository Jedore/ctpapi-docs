...
<span class="anchor" id="f2a83d5b-d0e4-4354-b232-17b47938c0af"></span>
## 1.函数原型
<p>virtual int ReqQryForQuote(CThostFtdcQryForQuoteField *pQryForQuote, int nRequestID) = 0;</p>
<span class="anchor" id="cffebd09-435e-45da-be5f-64e3a8fa3941"></span>
## 2.参数
...
<span class="anchor" id="5e9a705e-453f-4915-8e1c-4ec3595bae3a"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="6184472b-f6fd-47c4-9a99-e4a7354c278d"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="0accf1e3-cf62-47ba-8531-c2c2c9185263"></span>
## 5.FAQ
<p>无</p>
