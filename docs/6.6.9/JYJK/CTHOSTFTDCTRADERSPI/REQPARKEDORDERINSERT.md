...
<span class="anchor" id="9a89a3ed-4167-41bc-8ee2-c55d05cbe7dc"></span>
## 1.函数原型
<p>virtual int ReqParkedOrderInsert(CThostFtdcParkedOrderField *pParkedOrder, int nRequestID) = 0;</p>
<span class="anchor" id="8314ecf5-c7e1-4042-8cd0-d3e800a1fb47"></span>
## 2.参数
...
<span class="anchor" id="0dcbc596-abfa-4578-8a44-5d14a43242ce"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="858aa974-0c5e-4861-9c85-254d5efa9291"></span>
## 4.调用示例
...
<span class="anchor" id="3091209d-f100-407f-9678-30c2ba31dc77"></span>
## 5.FAQ
<p>无</p>
