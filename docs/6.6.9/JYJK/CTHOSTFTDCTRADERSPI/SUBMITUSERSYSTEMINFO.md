...
<span class="anchor" id="2d12c6d1-8e71-4504-814e-70fd0141822b"></span>
## 1.函数原型
<p>virtual int SubmitUserSystemInfo(CThostFtdcUserSystemInfoField *pUserSystemInfo) = 0;</p>
<span class="anchor" id="57e928f7-1dec-4d25-8aaf-2d3b84e980aa"></span>
## 2.参数
...
<span class="anchor" id="5c4f1ba5-1c8b-4aae-ae39-53a818ab931b"></span>
## 3.返回
<p>0 正确</p>
<p>-1 字段长度不对</p>
<p>-2 非CTP采集的终端信息</p>
...
<p>-6 采集结果字段错误</p>
<span class="anchor" id="a7dcafad-cb5c-410f-abf1-f475a3973da6"></span>
## 4.调用示例
<p>//一对多中继终端使用方法   </p>
...
<span class="anchor" id="38364e55-d7af-45b1-a0de-d2863c647a2a"></span>
## 5.FAQ
