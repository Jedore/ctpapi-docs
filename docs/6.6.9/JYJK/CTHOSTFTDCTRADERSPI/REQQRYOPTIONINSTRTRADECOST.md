...
<span class="anchor" id="ae69aaa2-d073-4a26-8c2b-9300fbeeafa9"></span>
## 1.函数原型
...
<span class="anchor" id="9824b52b-a848-4292-bc20-8c61b9aaeaab"></span>
## 2.参数
...
<span class="anchor" id="fd714c42-4b9e-4810-af53-ca3ac8e0355e"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="49ea0434-a353-46c5-8cff-52b61659eb9e"></span>
## 4.调用示例
...
<span class="anchor" id="d95ddf47-102a-4617-aa3a-997a852b7a0c"></span>
## 5.FAQ
