...
<span class="anchor" id="ca30b90f-a52e-4e0f-b89f-af47574a43ba"></span>
## 1.函数原型
<p>virtual int ReqFromBankToFutureByFuture(CThostFtdcReqTransferField *pReqTransfer, int nRequestID) = 0;</p>
<span class="anchor" id="bff800c2-dad1-4264-82e9-2b6dd0d458c2"></span>
## 2.参数
...
<span class="anchor" id="0b834c21-66fb-4429-804e-5d927cced3e2"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="1cb83de4-cec8-4615-8408-27ef98dec590"></span>
## 4.调用示例
...
<span class="anchor" id="b37da45e-0179-4cf8-ae9d-af2222a94879"></span>
## 5.FAQ
<p>无</p>
