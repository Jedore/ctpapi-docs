...
<span class="anchor" id="d13d6fbf-79b9-46e9-be0a-d60b5c323854"></span>
## 1.函数原型
...
<span class="anchor" id="ef1eafe5-1cbe-485c-bffe-6cd4dd8ba410"></span>
## 2.参数
...
<span class="anchor" id="f4c77a34-d4c7-41a2-b07e-7c1e8f7aa99c"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="44d6e037-9562-44ef-8372-fc5f0ddf7aff"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="b6e5e9db-2194-443e-b4c8-d100e2ed509e"></span>
## 5.FAQ
<p>无</p>
