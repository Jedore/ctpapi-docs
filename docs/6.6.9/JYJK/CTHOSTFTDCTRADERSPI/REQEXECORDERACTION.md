...
<span class="anchor" id="674d0c24-68d7-4cd3-8345-7d085a0373c0"></span>
## 1.函数原型
<p>virtual int ReqExecOrderAction(CThostFtdcInputExecOrderActionField *pInputExecOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="004e1da7-198d-4843-9057-6fd7039541a3"></span>
## 2.参数
...
<span class="anchor" id="c830d7bc-bba7-4b0e-b156-e14c2e183fb1"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="e9ca0b5c-a429-44b5-addc-06dabdbea516"></span>
## 4.调用示例
...
<span class="anchor" id="2416f457-3ba3-4e93-8a4a-1f6a93750926"></span>
## 5.FAQ
<p>无</p>
