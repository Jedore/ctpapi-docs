...
<span class="anchor" id="78e673a4-102f-4881-af35-a20c4187c7fe"></span>
## 1.函数原型
<p>virtual int ReqOptionSelfCloseInsert(CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose, int nRequestID) = 0;</p>
<span class="anchor" id="1564518f-e003-4433-ba1e-2d02e6c2d4c1"></span>
## 2.参数
...
<span class="anchor" id="7d79d03b-ff3f-4eb8-9499-0d9986889dab"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="377db8b9-42eb-4c88-9691-03fe5ebc2077"></span>
## 4.调用示例
...
<span class="anchor" id="4b0319e3-3f5f-4fa4-9c0b-e1fc07494fac"></span>
## 5.FAQ
