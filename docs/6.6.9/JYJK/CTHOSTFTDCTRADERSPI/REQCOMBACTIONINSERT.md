...
<span class="anchor" id="6e9f6cbd-328b-46f9-bb26-87297829d939"></span>
## 1.函数原型
<p>virtual int ReqCombActionInsert(CThostFtdcInputCombActionField *pInputCombAction, int nRequestID) = 0;</p>
<span class="anchor" id="09c423be-1bbd-4026-879c-c15ff7e99533"></span>
## 2.参数
...
<span class="anchor" id="8f4a6429-1eea-4c2d-a9fc-10a1fb80e25f"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="1bf597a5-11c7-4ac0-b2e7-878a7f1ad63e"></span>
## 4.调用示例
...
<span class="anchor" id="9a4ff8a6-a5b7-4cac-a308-c08b3368eaf8"></span>
## 5.FAQ
<p>无</p>
