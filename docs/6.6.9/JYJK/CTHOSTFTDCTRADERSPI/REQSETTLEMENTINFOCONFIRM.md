...
<span class="anchor" id="1992c90d-838f-4024-8250-2c0c9384321c"></span>
## 1.函数原型
<p>virtual int ReqSettlementInfoConfirm(CThostFtdcSettlementInfoConfirmField *pSettlementInfoConfirm, int nRequestID) = 0;</p>
<span class="anchor" id="2ec54c14-9a54-4eb0-a444-ea425f2dfaa6"></span>
## 2.参数
...
<span class="anchor" id="4d0ea636-5085-4e7f-bc2d-9ea286455cef"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="2edc1d6d-8878-4fa7-8bd5-09aa32c3b8c3"></span>
## 4.调用示例
...
<span class="anchor" id="8ffd77d6-9eef-4089-bb18-8cb7e2ce38a7"></span>
## 5.FAQ
<p>无</p>
