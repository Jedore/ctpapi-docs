...
<span class="anchor" id="6743def7-9065-45d5-bb33-23b238df2b6a"></span>
## 1.函数原型
<p>virtual int ReqOrderAction(CThostFtdcInputOrderActionField *pInputOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="e104aa54-46bd-4aad-9a0c-13a00b32031a"></span>
## 2.参数
...
<span class="anchor" id="397a7d23-043a-432e-b8f6-cd1adb150d7f"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="ec79349e-f10a-4a94-a3cd-4670d6dfa393"></span>
## 4.调用示例
...
<span class="anchor" id="c5669d59-8380-42f5-a8ca-5fc3936bc228"></span>
## 5.FAQ
<p>无</p>
