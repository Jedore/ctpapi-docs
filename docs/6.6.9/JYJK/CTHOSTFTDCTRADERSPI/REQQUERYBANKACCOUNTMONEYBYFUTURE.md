...
<span class="anchor" id="6e887fdc-ea01-41b5-bcb6-27d7061fb198"></span>
## 1.函数原型
<p>virtual int ReqQueryBankAccountMoneyByFuture(CThostFtdcReqQueryAccountField *pReqQueryAccount, int nRequestID) = 0;</p>
<span class="anchor" id="a1d7691c-b852-454f-9f9c-d072ebda24d1"></span>
## 2.参数
...
<span class="anchor" id="17d351eb-00f1-4296-b5a3-5edf28c00f76"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="a8c9f5c2-79b5-402c-bfbe-feeeaa6eb731"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="95f8f03f-df2b-492f-8f4e-bc57b240b417"></span>
## 5.FAQ
<p>无</p>
