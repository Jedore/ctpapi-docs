...
<span class="anchor" id="13469584-0bed-40e5-bf05-68cc29673ccc"></span>
## 1.函数原型
<p>virtual int ReqFromFutureToBankByFuture(CThostFtdcReqTransferField *pReqTransfer, int nRequestID) = 0;</p>
<span class="anchor" id="d221ae8a-a821-489a-9585-96eba958ba15"></span>
## 2.参数
...
<span class="anchor" id="ba04a7a4-110f-486a-9958-014aac052d8b"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="bbd5b02e-8b41-410a-81c1-13e17bbfe554"></span>
## 4.调用示例
...
<span class="anchor" id="265567ac-9982-42be-a639-da9107bee7b8"></span>
## 5.FAQ
<p>无</p>
