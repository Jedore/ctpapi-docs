...
<span class="anchor" id="3b426aaa-5874-421f-a6bd-81ea3d9cf53c"></span>
## 1.函数原型
<p>int CTP_GetSystemInfo(char* pSystemInfo, int&amp; nLen);</p>
<span class="anchor" id="e2b35dd1-fcca-4bc4-84b5-285d1981ec25"></span>
## 2.参数
...
<span class="anchor" id="59608155-6564-437d-9ec3-4d075a1e0144"></span>
## 3.返回
<p>0 为正确，非0为错误。</p>
...
<span class="anchor" id="08b83eb3-8015-45c7-8e3d-46c75158b8c5"></span>
## 4.调用示例
<pre><code>char pSystemInfo[344];
int len;
CTP_GetSystemInfo(pSystemInfo, len);
</code></pre>
<span class="anchor" id="6813420b-11d3-4b3e-a254-d900984829c7"></span>
## 5.FAQ
