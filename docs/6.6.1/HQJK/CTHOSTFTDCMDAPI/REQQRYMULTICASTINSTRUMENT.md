...
<span class="anchor" id="7903babb-0a2f-4562-9b99-93262fb63eb4"></span>
## 1.函数原型
<p>virtual int ReqQryMulticastInstrument(CThostFtdcQryMulticastInstrumentField *pQryMulticastInstrument, int nRequestID) = 0;</p>
<span class="anchor" id="5b5aa32e-ff4f-4d91-8614-2248507eb6ea"></span>
## 2.参数
...
<span class="anchor" id="51b87eda-1d8d-451e-a6be-74201a978be6"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="454cfd18-9e0a-4e2a-964a-a28b0bf835a6"></span>
## 4.调用示例
...
<span class="anchor" id="127cd44f-46ff-4c8f-9c30-aeb95e1569ad"></span>
## 5.FAQ
<p>无</p>
