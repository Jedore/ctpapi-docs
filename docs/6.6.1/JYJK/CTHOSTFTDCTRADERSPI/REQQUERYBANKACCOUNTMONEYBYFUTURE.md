...
<span class="anchor" id="25ada2ac-56a5-4bc4-92ab-496777f90494"></span>
## 1.函数原型
<p>virtual int ReqQueryBankAccountMoneyByFuture(CThostFtdcReqQueryAccountField *pReqQueryAccount, int nRequestID) = 0;</p>
<span class="anchor" id="7c9e6da3-3716-4252-a38f-2a8dc9697ca0"></span>
## 2.参数
...
<span class="anchor" id="eb4f426e-5065-4721-af13-5a3cfee0656f"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="794aa0b3-72f6-4eda-bfa7-634997db5030"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="3cdc5e69-045a-4da5-a959-d22f9cb6cac7"></span>
## 5.FAQ
<p>无</p>
