...
<span class="anchor" id="a608bcfe-cbb5-4b99-96e8-f643c5e22bfc"></span>
## 1.函数原型
<p>virtual int RegisterUserSystemInfo(CThostFtdcUserSystemInfoField *pUserSystemInfo) = 0;</p>
<span class="anchor" id="9328a855-e993-4b14-88b0-450b3b2c9977"></span>
## 2.参数
...
<span class="anchor" id="bc0b0782-9e7d-4709-9075-b68f51bba04e"></span>
## 3.返回
<p>0 正确</p>
<p>-1 字段长度不对</p>
<p>-2 非CTP采集的终端信息</p>
...
<p>-6 采集结果字段错误</p>
<span class="anchor" id="8e604c68-2c1f-45be-8a6f-a99fc44c6115"></span>
## 4.调用示例
<p>//多对多中继终端使用流程</p>
...
<span class="anchor" id="38b0fbe8-a537-4c85-88ff-a5d4588ee44f"></span>
## 5.FAQ
