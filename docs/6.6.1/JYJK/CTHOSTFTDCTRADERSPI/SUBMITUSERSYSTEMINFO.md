...
<span class="anchor" id="3c393737-e249-4edc-a39e-85894fbd742d"></span>
## 1.函数原型
<p>virtual int SubmitUserSystemInfo(CThostFtdcUserSystemInfoField *pUserSystemInfo) = 0;</p>
<span class="anchor" id="bbec00b2-ab7f-4165-9712-04f96962cc31"></span>
## 2.参数
...
<span class="anchor" id="71114348-fed1-4012-8d5b-e37075aced3b"></span>
## 3.返回
<p>0 正确</p>
<p>-1 字段长度不对</p>
<p>-2 非CTP采集的终端信息</p>
...
<p>-6 采集结果字段错误</p>
<span class="anchor" id="2a03f5d8-cbc0-420c-8fed-adb1bd54f779"></span>
## 4.调用示例
<p>//一对多中继终端使用方法   </p>
...
<span class="anchor" id="72d67474-286e-40c2-b004-c92b786da06c"></span>
## 5.FAQ
