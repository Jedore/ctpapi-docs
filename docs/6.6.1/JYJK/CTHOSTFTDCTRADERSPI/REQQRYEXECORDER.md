...
<span class="anchor" id="a98e536f-39e9-4ebe-8970-9d6362da5460"></span>
## 1.函数原型
<p>virtual int ReqQryExecOrder(CThostFtdcQryExecOrderField *pQryExecOrder, int nRequestID) = 0;</p>
<span class="anchor" id="b40fe039-1016-4bd4-a714-e636e2875fee"></span>
## 2.参数
...
<span class="anchor" id="75a844f8-a232-41a1-bfe3-4dc4e9d56b94"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="9e8c29d5-7b17-4046-8ee0-80bf00ec38f4"></span>
## 4.调用示例
...
<span class="anchor" id="d8f2a67b-9273-43ed-8157-a7736cf49f72"></span>
## 5.FAQ
<p>无</p>
