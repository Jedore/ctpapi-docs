...
<span class="anchor" id="2ae09d34-7832-49be-b8b4-9c9fdbcaa9db"></span>
## 1.函数原型
<p>virtual int ReqQryTrade(CThostFtdcQryTradeField *pQryTrade, int nRequestID) = 0;</p>
<span class="anchor" id="0753695b-110d-4549-b771-7e9ebb37f7f0"></span>
## 2.参数
<p>pQryTrade：查询成交</p>
...
<span class="anchor" id="1190f1b3-7ef3-4e42-af17-626839e94da9"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="c2294bb9-930d-4cae-bff5-141789f54888"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="7686546b-43bd-4e36-805b-a26c5d8f79c9"></span>
## 5.FAQ
<p>无</p>
