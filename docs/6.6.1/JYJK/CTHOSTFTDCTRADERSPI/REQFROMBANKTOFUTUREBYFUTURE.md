...
<span class="anchor" id="d5ecd978-0839-498e-8051-7e02d30dbc2a"></span>
## 1.函数原型
<p>virtual int ReqFromBankToFutureByFuture(CThostFtdcReqTransferField *pReqTransfer, int nRequestID) = 0;</p>
<span class="anchor" id="0900fb98-c40d-409e-ba5a-eef946aa2b13"></span>
## 2.参数
...
<span class="anchor" id="98182fce-5215-4596-947a-e2d6e2e5ed86"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="3b9c156a-2320-4e7c-a44c-83ced65954d8"></span>
## 4.调用示例
...
<span class="anchor" id="c05206c9-47f3-4412-8ac7-d2339d29c0e5"></span>
## 5.FAQ
<p>无</p>
