...
<span class="anchor" id="e4d3d0b5-eb37-4cb3-95b9-d27329f015f2"></span>
## 1.函数原型
<p>virtual int ReqBatchOrderAction(CThostFtdcInputBatchOrderActionField *pInputBatchOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="8575219d-e4b1-48e7-9aee-7e7d4541169b"></span>
## 2.参数
...
<span class="anchor" id="4dc3d17e-94ae-402d-8111-b0f93c1d59cb"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="46e31014-194d-4974-a1fc-027f6df55d9c"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="d1a7c921-9d17-4598-ac71-a10d6cd5af39"></span>
## 5.FAQ
<p>无</p>
