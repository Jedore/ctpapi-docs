...
<span class="anchor" id="15376049-b137-4d5c-ad7e-208c38076524"></span>
## 1.函数原型
<p>virtual int ReqQryOptionSelfClose(CThostFtdcQryOptionSelfCloseField *pQryOptionSelfClose, int nRequestID) = 0;</p>
<span class="anchor" id="8459c954-b948-49ed-8f49-9cc34ec064b0"></span>
## 2.参数
...
<span class="anchor" id="ebc01c37-d312-43d2-9f9a-2fca3a72afb7"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="f20edb61-5aa9-48e2-b1b2-9739e8b886a2"></span>
## 4.调用示例
...
<span class="anchor" id="32b164bc-bda4-4333-8ff1-c2a5ff113d34"></span>
## 5.FAQ
<p>无</p>
