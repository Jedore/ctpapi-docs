...
<span class="anchor" id="a012ae41-9c30-41d5-9610-16553dfbbd36"></span>
## 1.函数原型
...
<span class="anchor" id="e581b56f-2b06-4607-83e2-e6df666e4f37"></span>
## 2.参数
...
<span class="anchor" id="ee6350d7-4ded-45db-a812-5b749b1e55b8"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="170abafa-790c-400d-993c-9eb18cd14bdb"></span>
## 4.调用示例
...
<span class="anchor" id="9faa56f1-0cf5-4ac1-ab4d-6efe4ed7ef90"></span>
## 5.FAQ
<p>无</p>
