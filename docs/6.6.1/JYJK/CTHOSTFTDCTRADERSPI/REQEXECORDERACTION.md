...
<span class="anchor" id="1d2a6ea9-da05-4435-92ce-278653d6003b"></span>
## 1.函数原型
<p>virtual int ReqExecOrderAction(CThostFtdcInputExecOrderActionField *pInputExecOrderAction, int nRequestID) = 0;</p>
<span class="anchor" id="98c3a0fe-4f93-48b6-9e5a-545d7b174c6f"></span>
## 2.参数
...
<span class="anchor" id="136e844c-1aea-4174-91cf-6c256abe4056"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="80a08dcf-f02f-4b64-ac62-11ee84232fff"></span>
## 4.调用示例
...
<span class="anchor" id="dc84737d-4856-4c27-9927-0700f1a04bf3"></span>
## 5.FAQ
<p>无</p>
