...
<span class="anchor" id="c7267675-1fe2-4e39-b6f8-42c030ae06f4"></span>
## 1.函数原型
<p>virtual int ReqOrderInsert(CThostFtdcInputOrderField *pInputOrder, int nRequestID) = 0;</p>
<span class="anchor" id="680068c6-e898-4b81-8501-1df08e00f4fb"></span>
## 2.参数
...
<span class="anchor" id="b21efb61-9271-49f0-a65f-d59f6c7892e5"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="cba03e70-e907-4500-9778-6e51db781364"></span>
## 4.调用示例
<pre><code>//限价单:
...
<span class="anchor" id="815fcbd2-193a-4203-a596-618ff29f6aab"></span>
## 5.FAQ
