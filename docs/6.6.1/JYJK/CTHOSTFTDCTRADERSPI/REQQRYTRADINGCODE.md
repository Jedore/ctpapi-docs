...
<span class="anchor" id="83122a6d-9608-44c4-a6c5-c41eb2de6353"></span>
## 1.函数原型
<p>virtual int ReqQryTradingCode(CThostFtdcQryTradingCodeField *pQryTradingCode, int nRequestID) = 0;</p>
<span class="anchor" id="12a86c46-89e8-4323-83f5-ca44a9c0521d"></span>
## 2.参数
...
<span class="anchor" id="8b61fe56-af67-43ac-8933-0a5c3c8035e5"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="e472bb22-ea03-489c-a3af-06a6d0f842ab"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="92aad445-d188-486e-9907-81fc10f23c0b"></span>
## 5.FAQ
<p>无</p>
