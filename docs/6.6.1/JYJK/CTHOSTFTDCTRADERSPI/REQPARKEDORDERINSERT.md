...
<span class="anchor" id="6598f6a8-c77a-4274-844c-01e4e9405acb"></span>
## 1.函数原型
<p>virtual int ReqParkedOrderInsert(CThostFtdcParkedOrderField *pParkedOrder, int nRequestID) = 0;</p>
<span class="anchor" id="2964e6c1-1dc9-4c31-bfec-c0441fc0d45e"></span>
## 2.参数
...
<span class="anchor" id="65d50ed2-bc83-45a0-8205-c36dff75bcaa"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="b15558bc-d65e-4059-812c-625e4daa4cc6"></span>
## 4.调用示例
...
<span class="anchor" id="23a46b05-0051-45ef-a45e-e326216ad32b"></span>
## 5.FAQ
<p>无</p>
