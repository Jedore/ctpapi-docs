...
<span class="anchor" id="98f2df69-bb62-4e26-8f0d-becf7b2039a1"></span>
## 1.函数原型
<p>virtual int ReqQryQuote(CThostFtdcQryQuoteField *pQryQuote, int nRequestID) = 0;</p>
<span class="anchor" id="d84bf79a-e42d-4803-bd6d-f8fe9f9539b4"></span>
## 2.参数
<p>pQryQuote：报价查询</p>
...
<span class="anchor" id="0d28f8b6-46ed-4ab8-8ad4-21f85c360677"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="f3b0cd8c-e041-44c2-8d52-19dbc0cbb2e1"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="e4775aac-4bda-4ab1-a4be-b63fea98bc89"></span>
## 5.FAQ
<p>无</p>
