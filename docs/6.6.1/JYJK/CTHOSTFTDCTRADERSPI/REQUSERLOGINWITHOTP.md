...
<span class="anchor" id="70198973-9d51-4a4c-bbb2-af9ea0e422a3"></span>
## 1.函数原型
<p>virtual int ReqUserLoginWithOTP(CThostFtdcReqUserLoginWithOTPField *pReqUserLoginWithOTP, int nRequestID) = 0;</p>
<span class="anchor" id="80263b90-1cb8-4db5-8403-014e10d3fb04"></span>
## 2.参数
...
<span class="anchor" id="19bb5e56-f6ef-41d4-a20c-977fde52a087"></span>
## 3.返回
<p>0，代表成功。</p>
<p>-1，表示网络连接失败；</p>
<p>-2，表示未处理请求超过许可数；</p>
<p>-3，表示每秒发送请求数超过许可数。</p>
<span class="anchor" id="6173ae3b-34d2-4029-8a42-a5ab5e737ffc"></span>
## 4.调用示例
<p>无</p>
<span class="anchor" id="8f140f69-1a98-4e2a-9ba4-98bbb78c2398"></span>
## 5.FAQ
<p>无</p>
