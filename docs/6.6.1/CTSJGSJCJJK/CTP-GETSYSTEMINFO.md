...
<span class="anchor" id="4c6fb52c-0ed3-4bca-948a-347efef5b4c4"></span>
## 1.函数原型
<p>int CTP_GetSystemInfo(char* pSystemInfo, int&amp; nLen);</p>
<span class="anchor" id="88367c79-ad3b-4c12-ae4e-d716f3e07e15"></span>
## 2.参数
...
<span class="anchor" id="984976fa-0ae5-4748-a7fa-0d4b50dee98e"></span>
## 3.返回
<p>0 为正确，非0为错误。</p>
<span class="anchor" id="93a30521-18f0-4b44-aa76-77fc90ca5b97"></span>
## 4.调用示例
<pre><code>char pSystemInfo[344];
int len;
CTP_GetSystemInfo(pSystemInfo, len);
</code></pre>
<span class="anchor" id="5457726b-9153-4be9-81d7-4b749a6d5ec3"></span>
## 5.FAQ
